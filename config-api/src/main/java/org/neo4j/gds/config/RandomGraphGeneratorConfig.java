...
public interface RandomGraphGeneratorConfig extends GraphProjectConfig {
    ...
    @Configuration.ConvertWith(method = "org.neo4j.gds.Aggregation#parse")
    @Configuration.ToMapValue("org.neo4j.gds.Aggregation#toString")
    ...
    default RelationshipProjections relationshipProjections() {
        return new RelationshipProjections(
            Map.of(
                relationshipType(),
