...
public final class SourceNodesFactory {
    ...
    public static SourceNodes parse(Object object){
        ...
        var listSourceNodes = new ListSourceNodes(NodeIdParser.parseToListOfNodeIds(object, SourceNodes.SOURCE_NODES_KEY));
        nodesNotNegative(listSourceNodes.sourceNodes(), SourceNodes.SOURCE_NODES_KEY);
        return listSourceNodes;
    }

    public static SourceNodes parseAsList(Object object) {
        if ( object instanceof SourceNodes) {
            return (SourceNodes) object;
        }
        var listSourceNodes = new ListSourceNodes(NodeIdParser.parseToListOfNodeIds(object, SourceNodes.SOURCE_NODES_KEY));
