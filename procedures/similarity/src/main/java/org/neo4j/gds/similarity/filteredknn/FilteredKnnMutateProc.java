...
public class FilteredKnnMutateProc {
    ...
    public Stream<KnnMutateResult> mutate(
        ...
        return facade.algorithms().similarity().filteredKnnMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().similarity().filteredKnnMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
