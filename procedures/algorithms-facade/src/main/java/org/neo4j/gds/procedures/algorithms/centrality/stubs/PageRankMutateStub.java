...
public interface PageRankMutateStub<C extends RankConfig & MutateNodePropertyConfig> extends MutateStub<C, PageRankMutateResult> {
    @Override
    C parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<PageRankMutateResult> execute(
