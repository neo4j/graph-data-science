...
class NodeSimilarityResultBuilderForMutateMode implements ResultBuilder<NodeSimilarityMutateConfig, NodeSimilarityResult, SimilarityMutateResult, Pair<RelationshipsWritten, Map<String, Object>>> {
    @Override
