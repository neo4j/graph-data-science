...
public class BreadthFirstSearchResultBuilderForMutateMode implements ResultBuilder<BfsMutateConfig, HugeLongArray, PathFindingMutateResult, RelationshipsWritten> {
    @Override
