...
class HarmonicCentralityResultBuilderForWriteMode implements ResultBuilder<HarmonicCentralityWriteConfig, HarmonicResult, Stream<CentralityWriteResult>, NodePropertiesWritten> {
    ...
    HarmonicCentralityResultBuilderForWriteMode(boolean shouldComputeCentralityDistribution) {
