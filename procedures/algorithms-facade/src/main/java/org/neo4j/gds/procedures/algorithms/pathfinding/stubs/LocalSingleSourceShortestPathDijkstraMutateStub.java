...
public class LocalSingleSourceShortestPathDijkstraMutateStub implements
    SingleSourceShortestPathDijkstraMutateStub {
    ...
    public LocalSingleSourceShortestPathDijkstraMutateStub(
