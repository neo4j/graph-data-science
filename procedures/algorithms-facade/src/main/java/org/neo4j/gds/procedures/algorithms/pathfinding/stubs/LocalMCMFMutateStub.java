...
public class LocalMCMFMutateStub implements MCMFMutateStub {
    ...
    @Override
    public MCMFMutateConfig parseConfiguration(Map<String, Object> configuration) {
        return genericStub.parseConfiguration(MCMFMutateConfig::of, configuration);
    }
    ...
    @Override
    public Stream<MCMFMutateResult> execute(String graphName, Map<String, Object> configuration) {
        var resultBuilder = new MCMFResultBuilderForMutateMode();

        return genericStub.execute(
            graphName,
            configuration,
            MCMFMutateConfig::of,
            mutateModeBusinessFacade::mcmf,
            resultBuilder
        );
    }
