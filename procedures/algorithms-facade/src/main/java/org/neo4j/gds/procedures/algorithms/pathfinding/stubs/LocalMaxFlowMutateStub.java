...
public class LocalMaxFlowMutateStub implements
    MaxFlowMutateStub {
    ...
    @Override
    public MaxFlowMutateConfig parseConfiguration(Map<String, Object> configuration) {
        return genericStub.parseConfiguration(MaxFlowMutateConfig::of, configuration);
    }
    ...
    @Override
    public Stream<MaxFlowMutateResult> execute(String graphName, Map<String, Object> configuration) {
        var resultBuilder = new MaxFlowResultBuilderForMutateMode();

        return genericStub.execute(
            graphName,
            configuration,
            MaxFlowMutateConfig::of,
            mutateModeBusinessFacade::maxFlow,
            resultBuilder
        );
    }
