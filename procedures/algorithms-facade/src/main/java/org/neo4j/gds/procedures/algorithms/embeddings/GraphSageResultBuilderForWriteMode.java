...
class GraphSageResultBuilderForWriteMode implements ResultBuilder<GraphSageWriteConfig, GraphSageResult, Stream<DefaultNodeEmbeddingsWriteResult>, NodePropertiesWritten> {
    @Override
