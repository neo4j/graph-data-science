...
public interface SinglePairShortestPathYensMutateStub extends MutateStub<ShortestPathYensMutateConfig, PathFindingMutateResult> {
    @Override
    ShortestPathYensMutateConfig parseConfiguration(Map<String, Object> configuration);
