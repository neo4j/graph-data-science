...
class DegreeCentralityResultBuilderForStatsMode implements ResultBuilder<DegreeCentralityStatsConfig, CentralityAlgorithmResult, Stream<CentralityStatsResult>, Void> {
