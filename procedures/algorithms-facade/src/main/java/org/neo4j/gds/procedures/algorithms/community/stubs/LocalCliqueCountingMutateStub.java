...
public class LocalCliqueCountingMutateStub implements CliqueCountingMutateStub {
    ...
    public LocalCliqueCountingMutateStub(
    ...
    @Override
    public CliqueCountingMutateConfig parseConfiguration(Map<String, Object> configuration) {
        return genericStub.parseConfiguration(CliqueCountingMutateConfig::of, configuration);
    }
    ...
    @Override
    public Stream<CliqueCountingMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration) {
        var resultBuilder = new CliqueCountingResultBuilderForMutateMode();

        return genericStub.execute(
            graphNameAsString,
            rawConfiguration,
            CliqueCountingMutateConfig::of,
            mutateModeBusinessFacade::cliqueCounting,
            resultBuilder
        );
    }
