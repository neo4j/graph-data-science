...
public interface BFSMutateStub extends MutateStub<BfsMutateConfig, PathFindingMutateResult> {
    @Override
    BfsMutateConfig parseConfiguration(Map<String, Object> configuration);
