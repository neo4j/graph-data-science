...
public class DfsMutateProc {
    ...
    public Stream<PathFindingMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().depthFirstSearchMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().depthFirstSearchMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
