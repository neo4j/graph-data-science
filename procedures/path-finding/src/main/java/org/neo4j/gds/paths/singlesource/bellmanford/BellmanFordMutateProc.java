...
public class BellmanFordMutateProc {
    @Context
    ...
    public Stream<BellmanFordMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().bellmanFordMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().bellmanFordMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
