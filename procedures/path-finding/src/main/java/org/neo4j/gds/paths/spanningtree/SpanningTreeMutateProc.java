...
public class SpanningTreeMutateProc {
    ...
    public Stream<SpanningTreeMutateResult> spanningTree(
        ...
        return facade.algorithms().pathFinding().spanningTreeMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().spanningTreeMutateEstimate(graphName, configuration);
    }
