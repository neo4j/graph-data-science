...
public class AllShortestPathsDijkstraMutateProc {
    ...
    public Stream<PathFindingMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().singleSourceShortestPathDijkstraMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().singleSourceShortestPathDijkstraMutateEstimate(
