...
class MCMFStatsProcTest extends BaseProcTest {
    ...
    void setup() throws Exception {
        registerProcedures(MCMFStatsProc.class, GraphProjectProc.class);
    ...
    void testYields() {
        ...
        var rowCount = runQueryWithRowConsumer(
            ...
            res -> {
                ...
                assertThat(res.getNumber("totalCost").doubleValue()).isEqualTo(16D);
