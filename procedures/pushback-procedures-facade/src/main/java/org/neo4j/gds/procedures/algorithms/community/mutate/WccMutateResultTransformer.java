...
public class WccMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<DisjointSetStruct>, Stream<WccMutateResult>> {
    ...
    public WccMutateResultTransformer(
        ...
        Graph graph,
        GraphStore graphStore, StandardCommunityProperties standardCommunityProperties
    ) {
    ...
    @Override
    public Stream<WccMutateResult> apply(TimedAlgorithmResult<DisjointSetStruct> timedAlgorithmResult) {
