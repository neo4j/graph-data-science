...
public class ConductanceStreamTransformer implements ResultTransformer<TimedAlgorithmResult<ConductanceResult>, Stream<ConductanceStreamResult>> {

    @Override
    public Stream<ConductanceStreamResult> apply(
        TimedAlgorithmResult<ConductanceResult> timedAlgorithmResult
    ) {
        var conductanceResult = timedAlgorithmResult.result();
