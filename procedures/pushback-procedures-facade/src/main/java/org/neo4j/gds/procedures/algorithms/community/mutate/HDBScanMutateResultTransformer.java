...
public class HDBScanMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<Labels>, Stream<HDBScanMutateResult>> {
    ...
    @Override
    public Stream<HDBScanMutateResult> apply(TimedAlgorithmResult<Labels> timedAlgorithmResult) {
        ...
        var mutateResult = new HDBScanMutateResult(
            nodeCount,
