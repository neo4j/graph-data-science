...
public class SpeakerListenerLPAMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<PregelResult>, Stream<SpeakerListenerLPAMutateResult>> {
    ...
    public SpeakerListenerLPAMutateResultTransformer(
    ...
    @Override
    public Stream<SpeakerListenerLPAMutateResult> apply(TimedAlgorithmResult<PregelResult> timedAlgorithmResult) {
        ...
        var speakerListenerLPAMutateResult = new SpeakerListenerLPAMutateResult(
