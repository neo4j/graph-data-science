...
public class GenericCentralityResultStreamTransformer<R extends CentralityAlgorithmResult> implements ResultTransformer<TimedAlgorithmResult<R>,Stream<CentralityStreamResult>> {
    ...
    @Override
    public Stream<CentralityStreamResult> apply(TimedAlgorithmResult<R> timedAlgorithmResult) {
        CentralityAlgorithmResult centralityAlgorithmResult = timedAlgorithmResult.result();
