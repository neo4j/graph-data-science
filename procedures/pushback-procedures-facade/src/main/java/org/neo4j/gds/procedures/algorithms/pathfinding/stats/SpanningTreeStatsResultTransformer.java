...
class SpanningTreeStatsResultTransformer implements ResultTransformer<TimedAlgorithmResult<SpanningTree>, Stream<SpanningTreeStatsResult>> {

    private final Map<String, Object> configuration;

    SpanningTreeStatsResultTransformer(Map<String, Object> configuration) {
        this.configuration = configuration;
    }

    @Override
    public Stream<SpanningTreeStatsResult> apply(TimedAlgorithmResult<SpanningTree> algorithmResult) {
