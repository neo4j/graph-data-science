...
public class PrizeSteinerTreeMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<PrizeSteinerTreeResult>, Stream<PrizeCollectingSteinerTreeMutateResult>> {

    private final PrizeCollectingSteinerTreeMutateStep mutateStep;
    private final Graph graph;
    private final GraphStore graphStore;
    private final Map<String, Object> configuration;

    PrizeSteinerTreeMutateResultTransformer(
        PrizeCollectingSteinerTreeMutateStep mutateStep,
        Graph graph,
    ...
    @Override
    public Stream<PrizeCollectingSteinerTreeMutateResult> apply(TimedAlgorithmResult<PrizeSteinerTreeResult> algorithmResult) {
        ...
        return Stream.of(
            new PrizeCollectingSteinerTreeMutateResult(
                0,
