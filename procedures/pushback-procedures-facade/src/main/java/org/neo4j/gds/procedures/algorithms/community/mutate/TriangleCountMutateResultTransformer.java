...
public class TriangleCountMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<TriangleCountResult>, Stream<TriangleCountMutateResult>> {
    ...
    public TriangleCountMutateResultTransformer(
    ...
    @Override
    public Stream<TriangleCountMutateResult> apply(TimedAlgorithmResult<TriangleCountResult> timedAlgorithmResult) {
        ...
        var triangleCountMutateResult = new TriangleCountMutateResult(
