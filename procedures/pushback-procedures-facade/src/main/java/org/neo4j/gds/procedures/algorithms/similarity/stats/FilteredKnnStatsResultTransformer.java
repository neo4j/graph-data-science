...
public class FilteredKnnStatsResultTransformer implements ResultTransformer<TimedAlgorithmResult<FilteredKnnResult>, Stream<KnnStatsResult>> {
    ...
    public FilteredKnnStatsResultTransformer(
        Graph graph,
    ...
    @Override
    public Stream<KnnStatsResult> apply(TimedAlgorithmResult<FilteredKnnResult> timedAlgorithmResult) {
        var knnResult = timedAlgorithmResult.result();

        if (knnResult == FilteredKnnResult.EMPTY){
