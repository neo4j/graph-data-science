...
public class TriangleCountStatsResultTransformer implements ResultTransformer<TimedAlgorithmResult<TriangleCountResult>, Stream<TriangleCountStatsResult>> {

    private final Map<String, Object> configuration;
    private final long nodeCount;

    public TriangleCountStatsResultTransformer(Map<String, Object> configuration, long nodeCount) {
        this.configuration = configuration;
        this.nodeCount = nodeCount;
    }

    @Override
    public Stream<TriangleCountStatsResult> apply(TimedAlgorithmResult<TriangleCountResult> timedAlgorithmResult) {
