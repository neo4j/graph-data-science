...
public class KCoreMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<KCoreDecompositionResult>, Stream<KCoreDecompositionMutateResult>> {
    ...
    public KCoreMutateResultTransformer(
    ...
    @Override
    public Stream<KCoreDecompositionMutateResult> apply(TimedAlgorithmResult<KCoreDecompositionResult> timedAlgorithmResult) {
