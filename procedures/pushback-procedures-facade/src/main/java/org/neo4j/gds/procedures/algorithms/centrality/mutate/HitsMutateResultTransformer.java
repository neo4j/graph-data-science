...
public class HitsMutateResultTransformer implements ResultTransformer<TimedAlgorithmResult<HitsResultWithGraph>, Stream<HitsMutateResult>> {
    ...
    public HitsMutateResultTransformer(
        GraphStore graphStore,
        Map<String, Object> configuration,
        MutateNodePropertyService mutateNodePropertyService,
        Collection<String> labelsToUpdate, String authProperty, String hubProperty, String mutateProperty
    ) {
    ...
    @Override
    public Stream<HitsMutateResult> apply(TimedAlgorithmResult<HitsResultWithGraph> timedAlgorithmResult) {
        ...
        var pregelResult = result.pregelResult();
