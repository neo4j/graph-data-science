...
class DeltaSteppingMutateResultTransformerBuilder implements ResultTransformerBuilder<TimedAlgorithmResult<DeltaSteppingResult>, Stream<PathFindingMutateResult>> {

    private final MutateRelationshipService mutateRelationshipService;
    private final MutateRelationshipConfig configuration;

    DeltaSteppingMutateResultTransformerBuilder(
    ...
    @Override
    public DeltaSteppingMutateResultTransformer build(
        ...
        return new DeltaSteppingMutateResultTransformer(
            mutateStep,
