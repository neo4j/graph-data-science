...
class GenericRankWriteResultTransformerTest {
    ...
    void shouldTransform() {
        ...
        GenericRankWriteStep writeStep = mock(GenericRankWriteStep.class);
        ...
        var transformer = new GenericRankWriteResultTransformer(
            mock(Graph.class),
        ...
        assertThat(writeResult.findFirst().orElseThrow())
            .satisfies(write -> {
                ...
                assertThat(write.ranIterations()).isEqualTo(30);
            });
    }
