...
class ArticulationPointsMutateResultTransformerTest {
    ...
    void shouldTransform() {
        ...
        var transformer = new ArticulationPointsMutateResultTransformer(
            mock(Graph.class),
        ...
        assertThat(mutateResult.findFirst().orElseThrow())
            .satisfies(mutate -> {
                ...
                assertThat(mutate.articulationPointCount()).isEqualTo(2L);
