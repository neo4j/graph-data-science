...
class DeltaSteppingStatsResultTransformerTest {
    ...
    void shouldTransformToStatsResultWithNonEmptyConfig() {
        var config = Map.<String, Object>of("delta", 0.5);
        var transformer = new DeltaSteppingStatsResultTransformer(config);

        var timedResult = new TimedAlgorithmResult<>(pathFindingResultMock, 200L);
        ...
        assertThat(result.computeMillis()).isEqualTo(200L);
    ...
    void shouldTransformToStatsResultWithEmptyConfig() {
        ...
        var timedResult = new TimedAlgorithmResult<>(pathFindingResultMock, 0L);
    ...
    void shouldHandleNullConfigSupplier() {
        var transformer = new DeltaSteppingStatsResultTransformer(null);

        var timedResult = new TimedAlgorithmResult<>(pathFindingResultMock, 50L);
    ...
    void shouldHandleLargeComputeMillis() {
        ...
        var timedResult = new TimedAlgorithmResult<>(pathFindingResultMock, Long.MAX_VALUE);
