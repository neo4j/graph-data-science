...
class MaxFlowStreamResultTransformerTest {
    ...
    void shouldReturnEmptyStreamOnEmptyResult() {
        ...
        var transformer = new MaxFlowStreamResultTransformer(graphMock);

        var streamResult = transformer.apply(TimedAlgorithmResult.empty(FlowResult.EMPTY));
    ...
    void shouldTransformNonEmptyResult() {
        ...
        var streamResult = transformer.apply(new TimedAlgorithmResult<>(flowResult, 1L)).toList();
