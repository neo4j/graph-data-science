...
class SteinerTreeMutateResultTransformerTest {
    ...
    void shouldTransformToMutateResult() {
        ...
        var mutateStep = mock(SteinerTreeMutateStep.class);
        ...
        var transformer = new SteinerTreeMutateResultTransformer(mutateStep, graph, graphStore, config);
