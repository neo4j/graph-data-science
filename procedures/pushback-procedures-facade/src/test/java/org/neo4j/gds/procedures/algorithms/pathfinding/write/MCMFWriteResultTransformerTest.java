...
class MCMFWriteResultTransformerTest {
    ...
    void shouldTransformToWriteResult() {
        ...
        var transformer = new MCMFWriteResultTransformer(writeStep, graph, graphStore, resultStore, jobId, config);
        ...
        assertThat(result.totalCost()).isEqualTo(8D);
