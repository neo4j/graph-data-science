...
class SpeakerListenerLPAStatsResultTransformerTest {
    ...
    void shouldTransformResult(){
        ...
        when(result.ranIterations()).thenReturn(100);

        var transformer = new SpeakerListenerLPAStatsResultTransformer(config);
