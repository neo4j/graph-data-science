...
class CelfMutateResultTransformerTest {
    ...
    void shouldTransform() {
        ...
        var transformer = new CelfMutateResultTransformer(
            graph,
        ...
        assertThat(mutateResult.findFirst().orElseThrow())
            .satisfies(mutate -> {
                ...
                assertThat(mutate.totalSpread()).isEqualTo(44d);
                assertThat(mutate.nodePropertiesWritten()).isEqualTo(42L);
                assertThat(mutate.nodeCount()).isEqualTo(11L);
            });
    }
