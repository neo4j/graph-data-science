...
class BetaClosenessCentralityMutateResultTransformerTest {
    ...
    void shouldTransform() {
        ...
        var transformer = new BetaClosenessCentralityMutateResultTransformer(
            mock(Graph.class),
        ...
        assertThat(mutateResult.findFirst().orElseThrow())
            .satisfies(mutate -> {
                ...
                assertThat(mutate.mutateProperty()).isEqualTo("foo");
