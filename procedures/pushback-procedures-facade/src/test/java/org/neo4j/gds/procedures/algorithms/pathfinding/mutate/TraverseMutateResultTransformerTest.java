...
class TraverseMutateResultTransformerTest {
    ...
    void shouldTransformToMutateResult() {
        ...
        var mutateStep = mock(SearchMutateStep.class);

        var algoResult = mock(HugeLongArray.class);
        ...
        var transformer = new TraverseMutateResultTransformer(mutateStep, graph, graphStore, config);
    ...
    void shouldTransformEmptyResultToMutateResult() {
        ...
        var  algoResult = HugeLongArray.newArray(0);
