...
class BellmanFordMutateResultTransformerTest {
    ...
    void shouldTransformToMutateResult() {
        ...
        var mutateStep = mock(BellmanFordMutateStep.class);
        ...
        var transformer = new BellmanFordMutateResultTransformer(mutateStep, graph, graphStore, config);
        ...
        verify(mutateStep, times(1)).execute(graph, graphStore, bellmanFordResult);
    ...
    void shouldTransformEmptyResultToMutateResult() {
        ...
        var bellmanFordResult = BellmanFordResult.empty();
        ...
        assertThat(result.postProcessingMillis()).isZero();
        assertThat(result.configuration()).isEqualTo(config);
        assertThat(result.containsNegativeCycle()).as("Empty result should not have negative cycles").isFalse();
