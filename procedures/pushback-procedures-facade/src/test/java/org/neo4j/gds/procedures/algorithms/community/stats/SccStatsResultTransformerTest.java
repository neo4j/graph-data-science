...
class SccStatsResultTransformerTest {
    ...
    void shouldTransformResult(){
        ...
        var transformer = new SccStatsResultTransformer(config,instructions,new Concurrency(1));
        ...
        assertThat(statsResult.findFirst().orElseThrow())
            .satisfies(
                stats ->{
                    assertThat(stats.componentCount()).isEqualTo(3);
