...
class LeidenStatsResultTransformerTest {
    ...
    void shouldTransformResult(){
        ...
        var transformer = new LeidenStatsResultTransformer(config,instructions,new Concurrency(1));
        ...
        assertThat(statsResult.findFirst().orElseThrow())
            .satisfies(
                stats ->{
                    ...
                    assertThat(stats.nodeCount()).isEqualTo(6L);
