...
public class PageRankStatsProc {
    ...
    public Stream<PageRankStatsResult> stats(
        ...
        return facade.algorithms().centrality().pageRankStats(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().centrality().pageRankStatsEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
