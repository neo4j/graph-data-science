...
public class CELFMutateProc {
    ...
    public Stream<CELFMutateResult> mutate(
        ...
        return facade.algorithms().centrality().celfMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().centrality().celfMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
