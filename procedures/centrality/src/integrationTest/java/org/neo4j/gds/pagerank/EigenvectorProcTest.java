...
class EigenvectorProcTest extends BaseProcTest {
    ...
    static Stream<Arguments> scalers() {
        return Stream.of(
            Arguments.of(ScalerType.None.scalerName(),       0.04371, 0.99904),
            Arguments.of(ScalerType.Center.scalerName(),    -0.47766, 0.47766),
            Arguments.of(ScalerType.L1Norm.scalerName(),     0.04192, 0.95807),
            Arguments.of(ScalerType.L2Norm.scalerName(),     0.04371, 0.99904),
            Arguments.of(ScalerType.Mean.scalerName(),      -0.5, 0.5),
            Arguments.of(ScalerType.MinMax.scalerName(),     0.0, 1.0),
            Arguments.of(ScalerType.Max.scalerName(),        0.04375, 1.0)
        );
    }
