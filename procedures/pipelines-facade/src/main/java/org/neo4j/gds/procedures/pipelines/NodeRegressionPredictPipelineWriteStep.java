...
class NodeRegressionPredictPipelineWriteStep implements WriteStep<HugeDoubleArray, NodePropertiesWritten> {
    private final WriteNodePropertyService writeNodePropertyService;
    private final NodeRegressionPredictPipelineWriteConfig configuration;

    NodeRegressionPredictPipelineWriteStep(
    ...
    public NodePropertiesWritten execute(
        ...
        return writeNodePropertyService.perform(
            ...
            resultStore,
            configuration,
            new StandardLabel("NodeRegressionPipelineWrite"),
            jobId,
