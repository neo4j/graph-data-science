...
public class TriangleCountMutateProc {
    ...
    public Stream<TriangleCountMutateResult> write(
        ...
        return facade.algorithms().community().triangleCountMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().community().triangleCountMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
