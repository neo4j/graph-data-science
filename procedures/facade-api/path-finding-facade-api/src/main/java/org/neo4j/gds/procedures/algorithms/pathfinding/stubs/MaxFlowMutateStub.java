...
public interface MaxFlowMutateStub extends MutateStub<MaxFlowMutateConfig, MaxFlowMutateResult> {
    @Override
    MaxFlowMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<MaxFlowMutateResult> execute(String graphName, Map<String, Object> configuration);
}
