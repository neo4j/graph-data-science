...
public interface PrizeCollectingSteinerTreeMutateStub extends MutateStub<PCSTMutateConfig, PrizeCollectingSteinerTreeMutateResult> {
    @Override
    PCSTMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<PrizeCollectingSteinerTreeMutateResult> execute(String graphName, Map<String, Object> configuration);
}
