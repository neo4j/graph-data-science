...
public interface MCMFMutateStub extends MutateStub<MCMFMutateConfig, MCMFMutateResult> {
    @Override
    MCMFMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<MCMFMutateResult> execute(String graphName, Map<String, Object> configuration);
}
