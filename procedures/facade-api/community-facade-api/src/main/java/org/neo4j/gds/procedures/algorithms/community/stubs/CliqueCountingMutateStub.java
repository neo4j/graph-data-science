...
public interface CliqueCountingMutateStub extends MutateStub<CliqueCountingMutateConfig, CliqueCountingMutateResult> {
    @Override
    CliqueCountingMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<CliqueCountingMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration);
}
