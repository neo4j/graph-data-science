...
public interface WccMutateStub extends MutateStub<WccMutateConfig, WccMutateResult> {
    @Override
    WccMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<WccMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration);
}
