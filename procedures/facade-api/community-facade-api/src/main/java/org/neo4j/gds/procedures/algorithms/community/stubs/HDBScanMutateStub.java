...
public interface HDBScanMutateStub extends MutateStub<HDBScanMutateConfig, HDBScanMutateResult> {
    @Override
    HDBScanMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<HDBScanMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration);
}
