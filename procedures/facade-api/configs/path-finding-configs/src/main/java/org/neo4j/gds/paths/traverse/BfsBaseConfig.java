...
import static org.neo4j.gds.traversal.TraversalParameters.NO_MAX_DEPTH;

@Configuration
public interface BfsBaseConfig extends AlgoBaseConfig, SourceNodeConfig, TargetNodesConfig {
