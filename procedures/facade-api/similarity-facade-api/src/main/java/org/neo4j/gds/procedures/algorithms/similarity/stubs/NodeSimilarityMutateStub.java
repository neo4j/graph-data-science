...
public interface NodeSimilarityMutateStub extends MutateStub<NodeSimilarityMutateConfig, SimilarityMutateResult> {
    @Override
    NodeSimilarityMutateConfig parseConfiguration(Map<String, Object> configuration);
