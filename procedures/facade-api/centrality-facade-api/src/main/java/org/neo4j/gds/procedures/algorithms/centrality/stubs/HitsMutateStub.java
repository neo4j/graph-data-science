...
public interface HitsMutateStub extends MutateStub<HitsConfig, HitsMutateResult> {
    @Override
    HitsConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<HitsMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration);
}
