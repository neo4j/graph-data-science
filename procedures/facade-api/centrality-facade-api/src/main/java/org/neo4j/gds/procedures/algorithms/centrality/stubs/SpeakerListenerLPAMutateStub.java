...
public interface SpeakerListenerLPAMutateStub extends MutateStub<SpeakerListenerLPAConfig, SpeakerListenerLPAMutateResult> {
    @Override
    SpeakerListenerLPAConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<SpeakerListenerLPAMutateResult> execute(String graphNameAsString, Map<String, Object> rawConfiguration);
}
