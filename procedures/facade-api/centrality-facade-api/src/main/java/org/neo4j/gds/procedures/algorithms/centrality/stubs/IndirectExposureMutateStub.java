...
public interface IndirectExposureMutateStub extends MutateStub<org.neo4j.gds.indirectExposure.IndirectExposureMutateConfig, IndirectExposureMutateResult> {
    @Override
    IndirectExposureMutateConfig parseConfiguration(Map<String, Object> configuration);
    ...
    @Override
    Stream<IndirectExposureMutateResult> execute(
