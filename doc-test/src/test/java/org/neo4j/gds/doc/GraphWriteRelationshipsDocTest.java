...
final class GraphWriteRelationshipsDocTest extends SingleFileDocTestBase {
    ...
    protected String adocFile() {
        return "pages/management-ops/graph-write-to-neo4j/write-back-relationships.adoc";
    }
