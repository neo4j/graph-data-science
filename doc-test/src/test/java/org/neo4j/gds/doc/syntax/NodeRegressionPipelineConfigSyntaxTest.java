...
class NodeRegressionPipelineConfigSyntaxTest extends SyntaxTestBase {
    ...
    protected String adocFile() {
        return "pages/machine-learning/node-property-prediction/noderegression-pipelines/config.adoc";
    }
}
