...
public interface GdsTransactionApi {
    void registerCloseableResource(AutoCloseable resource, Runnable action);

    default void registerCloseableResource(AutoCloseable resource) {
        registerCloseableResource(resource, () -> {});
    }
