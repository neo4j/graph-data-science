 ...
 * @author mknblch
 */
public class ModernIntersectingTriangleCount extends Algorithm<ModernIntersectingTriangleCount, PagedAtomicIntegerArray> {
    ...
    public ModernIntersectingTriangleCount(Graph graph, ExecutorService executorService, int concurrency, AllocationTracker tracker) {
        this.graph = graph;
    ...
    @Override
    public final ModernIntersectingTriangleCount me() {
        return this;
    }
...
//        triangles = null;
    ...
    public double calculateCoefficient(int triangles, int degree) {
        if (triangles == 0) {
            return 0.0;
        }
