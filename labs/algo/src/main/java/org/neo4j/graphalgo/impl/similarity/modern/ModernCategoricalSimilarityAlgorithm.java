...
public abstract class ModernCategoricalSimilarityAlgorithm<ME extends ModernCategoricalSimilarityAlgorithm<ME>> extends ModernSimilarityAlgorithm<ME, CategoricalInput> {

    public ModernCategoricalSimilarityAlgorithm(ModernSimilarityConfig config, GraphDatabaseAPI api) {
        super(config, api);
    }
