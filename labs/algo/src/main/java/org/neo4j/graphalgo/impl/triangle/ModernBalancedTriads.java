 ...
 *
 */
public class ModernBalancedTriads extends Algorithm<ModernBalancedTriads, ModernBalancedTriads> {
    ...
    public ModernBalancedTriads(Graph graph, ExecutorService executorService, int concurrency, AllocationTracker tracker) {
        this.graph = graph;
    ...
    @Override
    public final ModernBalancedTriads me() {
        return this;
    }
     ...
     */
    @Override
    public ModernBalancedTriads compute() {
        visitedNodes.set(0);
        queue.set(0);
        balancedTriangleCount.reset();
        unbalancedTriangleCount.reset();
