...
public class ModernBalancedTriadsProc extends AlgoBaseProc<ModernBalancedTriads, ModernBalancedTriads, BalancedTriadsConfig> {

    @Procedure(name = "gds.alpha.balancedTriads.stream", mode = READ)
    public Stream<ModernBalancedTriads.Result> stream(
    ...
    @Override
    protected AlgorithmFactory<ModernBalancedTriads, BalancedTriadsConfig> algorithmFactory(BalancedTriadsConfig config) {
        return new AlphaAlgorithmFactory<ModernBalancedTriads, BalancedTriadsConfig>() {
            @Override
            public ModernBalancedTriads build(
                Graph graph,
                BalancedTriadsConfig configuration,
                AllocationTracker tracker,
                Log log
            ) {
                return new ModernBalancedTriads(
                    graph,
                    Pools.DEFAULT,
