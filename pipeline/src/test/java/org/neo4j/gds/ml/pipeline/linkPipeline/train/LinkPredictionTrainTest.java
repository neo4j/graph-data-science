    ...
    void logProgressRF() {
        ...
        assertThat(log.getMessages(TestLog.INFO))
            ...
            .containsExactlyInAnyOrder(
                ...
                "MY TEST TASK :: Extract train features 63%",
                "MY TEST TASK :: Extract train features 73%",
                "MY TEST TASK :: Extract train features 80%",
                "MY TEST TASK :: Extract train features 84%",
                "MY TEST TASK :: Extract train features 89%",
                "MY TEST TASK :: Extract train features 91%",
                "MY TEST TASK :: Extract train features 93%",
                "MY TEST TASK :: Extract train features 95%",
                "MY TEST TASK :: Extract train features 97%",
                ...
                "MY TEST TASK :: Select best model :: Trial 1 of 1 :: Parameters: {numberOfSamplesRatio=1.0, numberOfDecisionTrees=5, methodName=RandomForest, maxDepth=2147483647, minSplitSize=2}",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 50%",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 100%",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 :: Main validation metric: 0.3201",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 :: Validation metrics: {AUCPR=0.32012987012987015}",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 :: Training metrics: {AUCPR=0.31747835497835497}",
                ...
                "MY TEST TASK :: Evaluate on test data :: Extract test features 63%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 73%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 80%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 84%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 89%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 91%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 93%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 95%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 97%",
                ...
                "MY TEST TASK :: Final model metrics on test set: {AUCPR=0.1824878020530195}",
                "MY TEST TASK :: Final model metrics on full train set: {AUCPR=0.1824878020530195}",
    ...
    void logProgressLRWithRange() {
        ...
        assertThat(log.getMessages(TestLog.INFO))
            ...
            .containsExactly(
                ...
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.001902318112}",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 100%",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Main validation metric: 0.7169",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Validation metrics: {AUCPR=0.716914682539}",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Training metrics: {AUCPR=0.701170634920}",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Finished",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Start",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.056692516115}",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 100%",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Main validation metric: 0.7169",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Validation metrics: {AUCPR=0.716914682539}",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Training metrics: {AUCPR=0.701170634920}",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Finished",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Start",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=882.723345073077}",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 100%",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Main validation metric: 0.6812",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Validation metrics: {AUCPR=0.681150793650}",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Training metrics: {AUCPR=0.807697510822}",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Finished",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Start",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=254.129460046274}",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 100%",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Main validation metric: 0.6912",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Validation metrics: {AUCPR=0.691150793650}",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Training metrics: {AUCPR=0.800009018759}",
                ...
                "MY TEST TASK :: Select best model :: Finished",
                "MY TEST TASK :: Train best model :: Start",
                "MY TEST TASK :: Train best model :: Epoch 1 with loss 0.688097328918",
                "MY TEST TASK :: Train best model :: Epoch 2 with loss 0.683213701008",
                "MY TEST TASK :: Train best model :: Epoch 3 with loss 0.678498527915",
                "MY TEST TASK :: Train best model :: Epoch 4 with loss 0.673953027899",
                "MY TEST TASK :: Train best model :: Epoch 5 with loss 0.669577255253",
                "MY TEST TASK :: Train best model :: terminated after 5 epochs. Initial loss: 0.693147180559, Last loss: 0.669577255253. Did not converge",
                "MY TEST TASK :: Train best model 100%",
                "MY TEST TASK :: Train best model :: Finished",
                "MY TEST TASK :: Compute train metrics :: Start",
                "MY TEST TASK :: Compute train metrics 100%",
                ...
                "MY TEST TASK :: Evaluate on test data :: Compute test metrics :: Finished",
                "MY TEST TASK :: Evaluate on test data :: Finished",
                "MY TEST TASK :: Final model metrics on test set: {AUCPR=0.780858933729}",
                "MY TEST TASK :: Final model metrics on full train set: {AUCPR=0.780858933729}",
                "MY TEST TASK :: Finished"
            );
    }
