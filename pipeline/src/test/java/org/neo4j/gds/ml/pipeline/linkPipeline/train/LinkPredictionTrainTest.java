...
class LinkPredictionTrainTest {
    ...
    static Stream<Arguments> paramsForEstimationsWithParamSpace() {
        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                MemoryRange.of(12829024, 405699264)
            )
        );
    }
    ...
    @CsvSource(value = {
        "  10,   10, 3312, 77792",
        "  10,  100, 19120, 575760",
        "  10, 1000, 55232, 1729072",
        "1000, 1000, 55232, 1729072"
    })
