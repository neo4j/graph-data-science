    ...
    void logProgressLRWithRange() {
        ...
        assertThat(log.getMessages(TestLog.INFO))
            ...
            .containsExactly(
                ...
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.0019}",
                ...
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.0566}",
                ...
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=882.7233}",
                ...
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Parameters: {methodName=LogisticRegression, batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=254.1294}",
