    ...
    void logProgressRF() {
        ...
        assertThat(log.getMessages(TestLog.INFO))
            ...
            .containsExactlyInAnyOrder(
                ...
                "Method: RandomForest, Parameters: {criterion=GINI, numberOfSamplesRatio=1.0, numberOfDecisionTrees=5, maxDepth=2147483647, minSplitSize=2, minLeafSize=1}",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 50%",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 100%",
                "Main validation metric (AUCPR): 0.8085",
                "Validation metrics: {AUCPR=0.8085}",
                "Training metrics: {AUCPR=0.8332}",
                "MY TEST TASK :: Select best model :: Trial 1 of 1 :: Finished",
                "Best trial was Trial 1 with main validation metric 0.8085",
                ...
                "Final model metrics on full train set: {AUCPR=0.7117}",
                ...
                "Final model metrics on test set: {AUCPR=0.7117}",
    ...
    void logProgressLR() {
        ...
        assertThat(log.getMessages(TestLog.DEBUG))
            ...
            .contains(
                ...
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6883",
                "Epoch 2 with loss 0.6840",
                "Epoch 3 with loss 0.6800",
                "Epoch 4 with loss 0.6762",
                "Epoch 5 with loss 0.6725",
                "terminated after 5 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6725. Did not converge",
                "Finished fold 1 training",
                "Starting fold 2 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6877",
                "Epoch 2 with loss 0.6824",
                "Epoch 3 with loss 0.6773",
                "Epoch 4 with loss 0.6723",
                "Epoch 5 with loss 0.6674",
                "terminated after 5 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6674. Did not converge",
                "Finished fold 2 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6880",
                "Epoch 2 with loss 0.6832",
                "Epoch 3 with loss 0.6784",
                "Epoch 4 with loss 0.6739",
                "Epoch 5 with loss 0.6695",
                "terminated after 5 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6695. Did not converge"
            );
    }
    ...
    void logProgressLRWithRange() {
        ...
        assertThat(log.getMessages(TestLog.INFO))
            ...
            .containsExactly(
                ...
                "Method: LogisticRegression, Parameters: {batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.0019, focusWeight=0.0, classWeights=[]}",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 100%",
                "Main validation metric (AUCPR): 0.7169",
                "Validation metrics: {AUCPR=0.7169}",
                "Training metrics: {AUCPR=0.7011}",
                "MY TEST TASK :: Select best model :: Trial 1 of 4 :: Finished",
                "MY TEST TASK :: Select best model :: Trial 2 of 4 :: Start",
                "Method: LogisticRegression, Parameters: {batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=0.0566, focusWeight=0.0, classWeights=[]}",
                ...
                "Method: LogisticRegression, Parameters: {batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=882.7233, focusWeight=0.0, classWeights=[]}",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 100%",
                "Main validation metric (AUCPR): 0.6812",
                "Validation metrics: {AUCPR=0.6811}",
                "Training metrics: {AUCPR=0.8076}",
                "MY TEST TASK :: Select best model :: Trial 3 of 4 :: Finished",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Start",
                "Method: LogisticRegression, Parameters: {batchSize=100, minEpochs=1, patience=1, maxEpochs=5, tolerance=0.001, learningRate=0.001, penalty=254.1294, focusWeight=0.0, classWeights=[]}",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 50%",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 100%",
                "Main validation metric (AUCPR): 0.6912",
                "Validation metrics: {AUCPR=0.6911}",
                "Training metrics: {AUCPR=0.8000}",
                "MY TEST TASK :: Select best model :: Trial 4 of 4 :: Finished",
                "Best trial was Trial 1 with main validation metric 0.7169",
                "MY TEST TASK :: Select best model :: Finished",
                "MY TEST TASK :: Train best model :: Start",
                "MY TEST TASK :: Train best model 100%",
                "MY TEST TASK :: Train best model :: Finished",
                ...
                "MY TEST TASK :: Compute train metrics 100%",
                "MY TEST TASK :: Compute train metrics :: Finished",
                "Final model metrics on full train set: {AUCPR=0.7808}",
                "MY TEST TASK :: Evaluate on test data :: Start",
                "MY TEST TASK :: Evaluate on test data :: Extract test features :: Start",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 50%",
                "MY TEST TASK :: Evaluate on test data :: Extract test features 100%",
                ...
                "MY TEST TASK :: Evaluate on test data :: Compute test metrics :: Finished",
                "MY TEST TASK :: Evaluate on test data :: Finished",
                "Final model metrics on test set: {AUCPR=0.7808}",
                "MY TEST TASK :: Finished"
            );
        ...
        assertThat(log.getMessages(TestLog.DEBUG))
            ...
            .containsExactly(
                ...
                "Starting fold 1 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6936",
                "Epoch 2 with loss 0.6916",
                "Epoch 3 with loss 0.6922",
                "converged after 3 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6922.",
                "Finished fold 1 training",
                "Starting fold 2 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6930",
                "Epoch 2 with loss 0.6925",
                "converged after 2 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6925.",
                "Finished fold 2 training",
                "Starting fold 1 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6899",
                "Epoch 2 with loss 0.6873",
                "Epoch 3 with loss 0.6862",
                "Epoch 4 with loss 0.6862",
                "converged after 4 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6862.",
                "Finished fold 1 training",
                "Starting fold 2 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6892",
                "Epoch 2 with loss 0.6875",
                "Epoch 3 with loss 0.6874",
                "converged after 3 out of 5 epochs. Initial loss: 0.6931, Last loss: 0.6874.",
                "Finished fold 2 training",
                "Initial loss 0.6931",
                "Epoch 1 with loss 0.6880",
                "Epoch 2 with loss 0.6832",
