...
class PipelineCompanionTest {

    @Test
    void shouldEstimateTheSameRegardlessOfNodeCount() {
        var estimator = PipelineCompanion.memoryEstimationStatsMap(2, 5);
    ...
    void estimationShouldScaleWithMetricsAndParamsCounts() {
        ...
        var _1_05 = PipelineCompanion.memoryEstimationStatsMap(1, 5).estimate(dimensions, 1).memoryUsage();
        var _4_05 = PipelineCompanion.memoryEstimationStatsMap(4, 5).estimate(dimensions, 1).memoryUsage();
        var _1_10 = PipelineCompanion.memoryEstimationStatsMap(1, 10).estimate(dimensions, 1).memoryUsage();
        var _4_10 = PipelineCompanion.memoryEstimationStatsMap(4, 10).estimate(dimensions, 1).memoryUsage();
