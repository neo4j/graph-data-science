...
public class LoggingOnlyNodePropertyExecutor implements NodePropertyStepExecutor {
    private final ProgressTracker progressTracker;

    LoggingOnlyNodePropertyExecutor(
    ...
    public void executeNodePropertySteps(Pipeline<?> pipeline) {
        ...
        for (int i = 0; i < pipeline.nodePropertySteps().size(); i++) {
