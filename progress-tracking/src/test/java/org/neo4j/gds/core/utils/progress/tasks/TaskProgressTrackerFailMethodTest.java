...
class TaskProgressTrackerFailMethodTest {
    ...
    void failingTask() {
        ...
        var tracker = new TaskProgressTracker(failingTask, new TestLogAdapter(log), new Concurrency(1), EmptyTaskRegistryFactory.INSTANCE);
    ...
    void failingIntermediateTask() {
        ...
        var log = Neo4jProxy.testLog();
        var tracker = new TaskProgressTracker(rootTask, new TestLogAdapter(log), new Concurrency(1), EmptyTaskRegistryFactory.INSTANCE);
