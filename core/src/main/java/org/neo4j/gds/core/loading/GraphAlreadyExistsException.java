...
public class GraphAlreadyExistsException extends IllegalArgumentException {
    private final GraphStoreCatalog.UserCatalogKey userCatalogKey;

    public GraphAlreadyExistsException(GraphStoreCatalog.UserCatalogKey userCatalogKey) {
        super(
            formatWithLocale(
                "Graph with name `%s` already exists on database `%s`.",
