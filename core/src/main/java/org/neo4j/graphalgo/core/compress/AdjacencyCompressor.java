...
public interface AdjacencyCompressor extends AutoCloseable {
     ...
     * The provided {@code long[]} must be able to hold at least {@link org.neo4j.graphalgo.core.loading.CompressedLongArray#length()} elements.
     *
     * The input {@code values} might also store properties (called 'weights').
     * This can be checked with {@link org.neo4j.graphalgo.core.loading.CompressedLongArray#hasWeights()}
     * and read with {@link org.neo4j.graphalgo.core.loading.CompressedLongArray#weights()}.
     ...
     *
     * Implementors of this method can use the provided {@link org.neo4j.graphalgo.core.compress.LongArrayBuffer} to reuse existing allocations
