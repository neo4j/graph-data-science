...
public final class HugeAtomicDisjointSetStruct implements DisjointSetStruct {
    ...
    public HugeAtomicDisjointSetStruct(
        ...
        this.communities = HugeAtomicLongArray.newArray(
            capacity,
            LongPageCreator.of(concurrency, nodeId -> communityMapping.getLong(nodeId, -1)),
            tracker
        );
        maxCommunityId = new AtomicLong(communityMapping.getLongMaxPropertyValue().orElse(NO_SUCH_SEED_VALUE));
    }
