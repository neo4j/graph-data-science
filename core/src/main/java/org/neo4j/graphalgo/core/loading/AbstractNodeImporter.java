...
public class AbstractNodeImporter<B extends InternalIdMappingBuilder<A>, A extends IdMappingAllocator> implements NodeImporter {
    ...
    public long importNodes(NodesBatchBuffer buffer, PropertyReader reader) {
        ...
        @Nullable A adder = idMapBuilder.allocate(batchLength);
        if (adder == null) {
            return 0;
        }
