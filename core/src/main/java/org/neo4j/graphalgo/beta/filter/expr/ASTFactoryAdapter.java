...
abstract class ASTFactoryAdapter implements ASTFactory<NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, Expression, Expression, Expression.Variable, Expression.Property, NULL, NULL, NULL, NULL, NULL, NULL, InputPosition> {
    ...
    @Override
    public Expression filterExpression(InputPosition p, Expression.Variable v, Expression list, Expression where) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public Expression allExpression(InputPosition p, Expression.Variable v, Expression list, Expression where) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Expression anyExpression(InputPosition p, Expression.Variable v, Expression list, Expression where) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Expression noneExpression(InputPosition p, Expression.Variable v, Expression list, Expression where) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Expression singleExpression(InputPosition p, Expression.Variable v, Expression list, Expression where) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public Expression mapProjection(InputPosition p, Expression.Variable v, List<NULL> nulls) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public NULL mapProjectionVariable(Expression.Variable v) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public Expression newStringParameter(InputPosition p, Expression.Variable v) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public NULL usingJoin(InputPosition p, List<Expression.Variable> joinVariables) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public NULL setLabels(Expression.Variable variable, List<StringPos<InputPosition>> value) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public NULL removeLabels(Expression.Variable variable, List<StringPos<InputPosition>> labels) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public NULL namedPattern(Expression.Variable v, NULL aNull) {
        throw new UnsupportedOperationException();
    }
