...
public class IdMapTest {
    ...
    @Test
    public void shouldComputeMemoryRequirements() {
        GraphDimensions dimensions = new GraphDimensions.Builder().setNodeCount(0).setHighestNeoId(0).build();
        MemoryTree memRec = IdMap.memoryRequirements().apply(dimensions, 1);
        ...
        memRec = IdMap.memoryRequirements().apply(dimensions, 1);
