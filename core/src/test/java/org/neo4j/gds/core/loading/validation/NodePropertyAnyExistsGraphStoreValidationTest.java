...
class NodePropertyAnyExistsGraphStoreValidationTest {
    ...
    void shouldThrowForNonexistingPropertyInEveryLabel() {
        ...
        assertThatThrownBy(() -> validation.validatePropertyExists(
            ...
            "Node Property `p` is not present for any requested node labels. Requested labels: ['Node', 'Node1']. Labels with `p` present: []"
        );
    }
