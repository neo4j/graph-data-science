...
class ProgressEventHandlerTest {
    ...
    void testConsumerLifecycle() {
        ...
        var event1 = ImmutableProgressEvent.of(username, new JobId(), Tasks.leaf("foo"));
        queue.add(event1);
        ...
        // add another event
        var event2 = ImmutableProgressEvent.of(username, new JobId(), Tasks.leaf("bar"));
        queue.add(event2);
    ...
    void shouldKnowWhenEventStoreIsEmpty() {
        ...
        var event1 = ImmutableProgressEvent.of(username, jobId, Tasks.leaf("foo"));
        queue.add(event1);
        ...
        var event2 = ImmutableProgressEvent.of(username, jobId, Tasks.leaf("bar"));
        queue.add(event2);
        fakeClockScheduler.forward(100, TimeUnit.MILLISECONDS);
