...
class IntLongArrayImplTest {

    @Test
    void longArrayValue() {
        var value = new IntLongArrayImpl(new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9});
        assertThat(value.longArrayValue()).isEqualTo(new long[]{1, 2, 3, 4, 5, 6, 7, 8, 9});
    }

    @Test
    void longValue() {
        var value = new IntLongArrayImpl(new int[]{1, 2, 3});
    ...
    void testEquals() {
        ...
        assertThat(new IntLongArrayImpl(new int[]{})).isEqualTo(PrimitiveValues.EMPTY_LONG_ARRAY);

        var value = new IntLongArrayImpl(new int[]{1, 2, 3});
        // equal to another instance if the held values are equal
        assertThat(value).isEqualTo(new IntLongArrayImpl(new int[]{1, 2, 3}));
        // equal to an array if the held array is equal
        assertThat(value.equals(new int[]{1, 2, 3})).isTrue();
    }
}
