...
class DegreeCentralitySyntaxTest extends SyntaxTestBase {
    ...
    protected Map<GenericSyntaxTreeProcessor.SyntaxMode, Class<?>> syntaxModes() {
        return Map.of(
            ...
            STATS, DegreeCentralityStatsProc.StatsResult.class,
            MUTATE, DegreeCentralityMutateProc.MutateResult.class,
            WRITE, DegreeCentralityWriteProc.WriteResult.class
        );
    }
