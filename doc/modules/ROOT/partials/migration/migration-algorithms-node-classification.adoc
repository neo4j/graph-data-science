...
The original alpha version of node classification has been completely removed and incorporated into xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[node classification pipelines].
