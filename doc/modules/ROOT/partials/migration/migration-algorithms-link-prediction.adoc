...
The original alpha version of link prediction has been completely removed and incorporated into xref::machine-learning/linkprediction-pipelines.adoc[link prediction pipelines].
Before training a link prediction model, you must xref::machine-learning/linkprediction-pipelines.adoc#linkprediction-creating-a-pipeline[create] and configure a training pipeline.
...
The remaining parts are moved to the xref::machine-learning/linkprediction-pipelines.adoc#linkprediction-pipelines-train[pipeline train procedure].
