...
The original alpha version of link prediction has been completely removed and incorporated into xref::machine-learning/linkprediction-pipelines/index.adoc[link prediction pipelines].
