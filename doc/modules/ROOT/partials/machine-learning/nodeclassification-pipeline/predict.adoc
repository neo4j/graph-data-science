...
After xref::machine-learning/nodeclassification-pipelines.adoc#nodeclassification-pipelines-train[training], the runnable model is of type `{modelType}` and resides in the xref::model-catalog/index.adoc[model catalog].
...
include::partial$/machine-learning/nodeclassification-pipeline/specific-stream-configuration.adoc[]
...
include::partial$/machine-learning/nodeclassification-pipeline/specific-write-mutate-configuration.adoc[]
...
We will use the model which we trained in the xref::machine-learning/nodeclassification-pipelines.adoc#nodeclassification-pipelines-train[train example] which we gave the name `'nc-pipeline-model'`.
