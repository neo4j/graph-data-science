...
| xref::common-usage/running-algos.adoc#common-configuration-tolerance[tolerance]                                     | Float         | 1e-4      | yes      | Tolerance used for the early convergence of an epoch.
...
| xref::common-usage/running-algos.adoc#common-configuration-max-iterations[maxIterations]                            | Integer       | 10        | yes      | Maximum number of weight updates per batch. Batches can also converge early based on `tolerance`.
