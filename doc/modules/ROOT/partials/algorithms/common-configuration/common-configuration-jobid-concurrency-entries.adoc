...
ifeval::[{sequential} == true]
| xref:common-usage/running-algos.adoc#common-configuration-concurrency[concurrency]              | Integer  | 1       | yes      | No concurrent threads can be used for this algorithm. Changing this parameter will have no effect.
endif::[]
