...
| xref::algorithms/alpha/kmeans.adoc#algorithms-kmeans-introduction-sampling[initialSampler]         | String          | "uniform" | yes      | The method used to sample the first `k` centroids. "uniform" and "kmeanspp", both case-insensitive, are valid inputs.
