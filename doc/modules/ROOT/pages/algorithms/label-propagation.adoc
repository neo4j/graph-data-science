...
[[algorithms-label-propagation-syntax-anonymous]]
=== Anonymous graphs
...
The results are the same as for running write mode with a named graph, see the xref::algorithms/label-propagation.adoc#algorithms-label-propagation-syntax[write mode syntax above].
