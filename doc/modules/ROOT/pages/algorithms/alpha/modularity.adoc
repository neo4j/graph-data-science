...
| modularities          | List of Float | The modularity scores for each community. Note that the list may be incomplete if the number of communities is higher thant `Ingeter.MAX_VALUE`.
...
YIELD nodeCount, relationshipCount, communityCount, modularity, modularities
----

.Results
[opts="header"]
|===
| nodeCount | relationshipCount | communityCount | modularity           | modularities
| 6         | 14                | 3              | 0.293388429752066    | [0.05785123966942149, 0.10537190082644629, 0.13016528925619833]
|===
--
