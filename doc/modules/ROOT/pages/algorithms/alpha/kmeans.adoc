...
It is also possible to explicitly give the list of initial centroids to the algorithm. In this case, the value of the `initialSampler` parameter is ignored, even if changed in the configuration.
