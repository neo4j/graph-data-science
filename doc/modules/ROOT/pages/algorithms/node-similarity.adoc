...
Weighted node similarity is computed as the weighted Jaccard similarty, according to the formula:
...
The weighted node similarity of Alice and Dave is hence:
