...
* Alpha
** xref:algorithms/topological-link-prediction/adamic-adar.adoc[Adamic Adar]
** xref:algorithms/topological-link-prediction/common-neighbors.adoc[Common Neighbors]
** xref:algorithms/topological-link-prediction/preferential-attachment.adoc[Preferential Attachment]
** xref:algorithms/topological-link-prediction/resource-allocation.adoc[Resource Allocation]
** xref:algorithms/topological-link-prediction/same-community.adoc[Same Community]
** xref:algorithms/topological-link-prediction/total-neighbors.adoc[Total Neighbors]
