...
Both xref::algorithms/ml-models/node-classification.adoc[Node Classification] and xref::algorithms/ml-models/linkprediction.adoc[Link Prediction] have training parameters that can be tuned automatically given a set of allowed values.
