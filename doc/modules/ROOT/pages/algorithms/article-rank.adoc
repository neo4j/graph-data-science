...
[[algorithms-article-rank-examples-biased-personalised]]
=== Biased Personalized Article Rank
Similarly to Personalized PageRank, GDS allows weighing the `sourceNodes` differently, increasing the likeliness of teleportation to some nodes more than others.

The following example shows how to run Article Rank centered around 'Site A' and 'Site B' with twice as high bias for 'Site B' than 'Site A'.
...
|===
| name      | score
| "Site A"  | 0.111778363215653612
| "Site B"  | 0.009744780382903134
| "Home"    | 0.009744780382903134
| "About"   | 0.105531128039947505
| "Links"   | 0.171319162167929667
| "Product" | 0.321319162167929662
| "Site C"  | 0.021319162167929635
| "Site D"  | 0.021319162167929635
|===
--
