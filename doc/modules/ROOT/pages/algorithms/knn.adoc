...
See the xref::alpha-algorithms/cosine.adoc#algorithms-similarity-cosine-context[Cosine Similarity] algorithm for more details.
...
include::partial$/algorithms/beta/knn-specific-algo-config.adoc[]
