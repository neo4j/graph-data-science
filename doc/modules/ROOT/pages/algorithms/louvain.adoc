...
The results are the same as for running write mode with a named graph, see the xref::algorithms/louvain.adoc#algorithms-louvain-syntax[write mode syntax above].
