...
For an example on how to expose a custom Pregel computation via a Neo4j procedure, have a look at the https://github.com/neo4j/graph-data-science/tree/2.5/examples/pregel-example/src/main/java/org/neo4j/gds/beta/pregel[Pregel examples].
...
The https://github.com/neo4j/graph-data-science/tree/2.5/examples/pregel-bootstrap[pregel-bootstrap] project is a good starting point.
...
The https://github.com/neo4j/graph-data-science/tree/2.5/examples/pregel-example[pregel-examples] module contains a set of examples for Pregel algorithms.
