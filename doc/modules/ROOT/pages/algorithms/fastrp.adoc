...
We will return to xref::algorithms/fastrp.adoc#algorithms-embeddings-fastrp-node-self-influence[Node Self Influence] later on.
...
include::partial$/algorithms/fastrp/specific-configuration.adoc[]
...
include::partial$/algorithms/common-configuration/common-configuration-anonymous-graph.adoc[]

include::partial$/algorithms/fastrp/specific-configuration.adoc[]

The results are the same as for running write mode with a named graph, see the xref::algorithms/fastrp.adoc#algorithms-embeddings-fastrp-syntax[write mode syntax above].
