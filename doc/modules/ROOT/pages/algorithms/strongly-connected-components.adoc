...
| xref:common-usage/running-algos.adoc#common-configuration-write-property[writeProperty]         | String      | "componentId"                  | yes       | The node property in the Neo4j database to which the {result} is written.
|===
