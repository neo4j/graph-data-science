...
[[algorithms-page-rank-examples-biased-personalised]]
...
The following example shows how to run PageRank centered around 'Site A' and 'Site B', with twice as high bias for 'Site B' than 'Site A'.
...
|===
| name      | score
| Home      | 1.1970687132755635
| About     | 0.33660455242122994
| Product   | 0.33660455242122994
| Links     | 0.33660455242122994
| Site A    | 0.20670975905180075
| Site B    | 0.3567097590518008
| Site C    | 0.05670975905180073
| Site D    | 0.05670975905180073
|===
--
