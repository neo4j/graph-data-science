...
For more information on relationship orientations, see the xref:management-ops/projections/graph-project.adoc#relationship-projection-syntax[relationship projection syntax section].
