...
The results are the same as for running write mode with a named graph, see the xref::algorithms/betweenness-centrality.adoc#algorithms-betweenness-centrality-syntax[write mode syntax above].
