...
| xref:common-usage/running-algos.adoc#common-configuration-write-property[minCommunitySize]     | Integer  | 0                      | yes      | Only community ids of communities with a size greater than or equal to the given value are written to Neo4j.
|===
