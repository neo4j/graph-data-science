...
[role=query-example]
--
.The following will run the algorithm on a component without negative cycles and stream results:
...
[role=query-example]
--
.The following will run the algorithm on a component with a negative cycle and stream results:
[source, cypher, role=noplay]
----
