...
include::partial$/algorithms/beta/node2vec/specific-configuration.adoc[]
...
The results are the same as for running write mode with a named graph, see the xref::algorithms/node2vec.adoc#algorithms-embeddings-node2vec-syntax[write mode syntax above].
