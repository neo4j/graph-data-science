...
include::partial$/algorithms/triangle-count/specific-configuration-stream.adoc[]
|===
...
| Name          | Type   | Default | Optional | Description
include::partial$/algorithms/common-configuration/common-mutate-configuration-entries.adoc[]
include::partial$/algorithms/triangle-count/specific-configuration-write.adoc[]
|===
