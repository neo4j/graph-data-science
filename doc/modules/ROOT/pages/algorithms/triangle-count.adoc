...
The results are the same as for running write mode with a named graph, see the xref::algorithms/triangle-count.adoc#algorithms-triangle-count-syntax[write mode syntax above].
