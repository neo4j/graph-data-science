...
[.alpha]
= Euclidean Distance
:description: This section describes the Euclidean Distance algorithm in the Neo4j Graph Data Science library. 
...
include::partial$/algorithms/alpha/alpha-similarity.adoc[tag=weighted-function-note]
...
include::partial$/algorithms/alpha/alpha-similarity.adoc[tag=computation]
include::partial$/algorithms/alpha/alpha-similarity.adoc[tag=weighted-note]
...
include::partial$/algorithms/alpha/alpha-similarity.adoc[tag=source-target-ids]
...
include::partial$/algorithms/alpha/alpha-cypher-similarity-explanation.adoc[]
