...
[.alpha]
= Jaccard Similarity
:description: This section describes the Jaccard Similarity algorithm in the Neo4j Graph Data Science library. 
...
A related procedure for computing Jaccard similarity is described in xref::algorithms/node-similarity.adoc[Node Similarity].
