...
`C` denotes a configurable constant offset, which can be used to avoid negative values or zeros in the value space, as these are not finite values.
...
Learning this value, we can use a slightly greater value, thus ensuring that the logarithm will be a finite value.
We will use `4.13`.
...
|===
| name       | scaledProperty
| "Beach"    | [2.005525858729668]
| "Central"  | [3.141130476243348]
| "East"     | [2.1198634561787513]
| "Forest"   | [1.0750024230289759]
| "Mountain" | [2.382320061012899]
| "Plaza"    | [2.503891949699081]
| "Polar"    | [1.4206957878372228]
| "West"     | [-4.605170185988113]
|===
--

As we can see, all scaled values are finite numbers.
Try this example with a lower offset value if you are curious about the results.
