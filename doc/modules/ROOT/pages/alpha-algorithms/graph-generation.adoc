...
|===
| Name                      | Type      | Default  | Optional | Description
| relationshipDistribution  | String    | UNIFORM  | yes      | The probability distribution method used to connect generated nodes. For more information see xref::alpha-algorithms/graph-generation.adoc#graph-generation-distribution[Relationship Distribution].
| relationshipSeed          | Integer   | null     | yes      | The seed used for generating relationships.
| relationshipProperty      | Map       | {}       | yes      | Describes the method used to generate a relationship property. By default no relationship property is generated. For more information see xref::alpha-algorithms/graph-generation.adoc#graph-generation-relationship-property[Relationship Property].
| aggregation               | String    | NONE     | yes      | The relationship aggregation method cf. xref::graph-project.adoc#relationship-projection-syntax[Relationship Projection].
