...
| sourceNodeLabels           | List of String    | ['*']                  | yes      | Filter the selected relationships using the given sourceNodeLabels.

| targetNodeLabels           | List of String    | ['*']                  | yes      | Filter the selected relationships using the given targetNodeLabels.
...
| remainingRelationshipType     | String         | n/a             | no        | Relationship type used for the remaining set. Relationships where one node has neither source nor target labels will be omitted.
