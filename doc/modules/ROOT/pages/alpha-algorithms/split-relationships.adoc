...
| sourceNodeLabels           | List of String    | ['*']                  | yes      | Filter the selected relationships where the sourceNode has at least one of the sourceNodeLabels.

| targetNodeLabels           | List of String    | ['*']                  | yes      | Filter the selected relationships where the targetNode has at least one of the targetNodeLabels.
...
| remainingRelationshipType     | String         | n/a             | no        | Relationships where one node has none of the source or target labels will be omitted.
