...
NOTE: Currently only xref:management-ops/projections/graph-project-cypher-projection.adoc[Cypher projection] is supported for projecting in-memory graphs on a Composite database.
