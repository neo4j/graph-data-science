...
[NOTE]
======
Please refer to the https://neo4j.com/docs/operations-manual/current/clustering/[official Neo4j documentation] for details on how to setup Neo4j cluster.
...
For more information on setting up, configuring and managing a Neo4j clustering, please refer to https://neo4j.com/docs/operations-manual/current/clustering/[the documentation].
