...
To exemplify listing pipelines, we create a xref::machine-learning/nodeclassification-pipelines.adoc[node classification pipeline] and a xref::machine-learning/linkprediction-pipelines.adoc[link prediction pipeline] so that we have something to list.
