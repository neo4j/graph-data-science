...
To exemplify listing pipelines, we create a xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[node classification pipeline] and a xref::machine-learning/linkprediction-pipelines/index.adoc[link prediction pipeline] so that we have something to list.
