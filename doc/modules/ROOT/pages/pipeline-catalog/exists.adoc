...
To exemplify this, we create a xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[node classification pipeline] and check for its existence.
