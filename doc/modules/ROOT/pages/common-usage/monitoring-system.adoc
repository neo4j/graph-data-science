...
To inspect the graphs in the graph catalog you can use the xref:management-ops/inspecting-the-graph-catalog.adoc#catalog-graph-list[Graph list] procedure.
====
