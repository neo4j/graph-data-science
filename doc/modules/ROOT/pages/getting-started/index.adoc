...
include::partial$use-labs-ai-tools.adoc[]
...
image::algorithm-modes.svg[Basic workflow showing how graph data science works in Neo4j,450,role=popup]
...
image::pipeline-model.svg[Basic workflow showing how machine learning works in Neo4j,450,role=popup]
