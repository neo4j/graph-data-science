...
In this case, the three parameters `writeRelationshipType`, `writeNodeIds`, and `writeCosts` are used to create the new `:PATH` relationship with the `totalCost`, `nodeIds`, and `costs` relationship properties.
