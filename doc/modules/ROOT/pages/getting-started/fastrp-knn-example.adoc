...
image::example-graphs/knn-fastrp.svg[Visualization of the example graph,600,role=popup]
...
If we were to examine Person-Product similariteies, this could be accomplished by using instead xref:algorithms/filtered-knn.adoc#algorithms-filtered-knn[Filtered K-Nearest Neighbors].
