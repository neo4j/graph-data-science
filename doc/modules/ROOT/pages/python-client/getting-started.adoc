...
* To configure and use xref::machine-learning/index.adoc[machine learning pipelines] in GDS, specific xref::python-client/pipelines.adoc[pipeline objects] are used in the Python client.
