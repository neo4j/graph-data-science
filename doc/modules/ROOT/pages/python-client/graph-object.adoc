...
The Python client syntax for using a `Graph` as input to an algorithm follows the standard Cypher API, where the graph is the first parameter passed to the algorithm.
