...
image::example-graphs/convert-relationships-graph.svg[Visualization of the example graph after converting the relationships to undirected,450,role=popup]
