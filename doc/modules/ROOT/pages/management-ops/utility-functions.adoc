...
The utility function `gds.util.NaN` can be used as an default value for input parameters, as shown in the examples of xref::alpha-algorithms/cosine.adoc#algorithms-similarity-cosine-procedure-sample[cosine similarity].
