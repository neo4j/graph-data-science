...
Besides, you can xref:management-ops/graph-update/mutate-node-labels.adoc[update node labels], xref:management-ops/graph-update/mutate-scale-properties.adoc[scale node properties], xref:management-ops/graph-update/to-undirected.adoc[convert relationships] from directed to undirected, and xref:management-ops/graph-update/collapse-path.adoc[collapse path].
