...
Those are documented in xref:management-ops/graph-inspection/graph-streaming.adoc#_nodes[Streaming nodes] and xref:management-ops/graph-inspection/graph-streaming.adoc#_relationships[Streaming Relationship].
...
The `procedure_name` indicates that we mirror the behaviour of the existing xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-single-node-property-example[procedure].
...
The `procedure_name` indicates that we mirror the behaviour of the existing xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-node-properties-example[procedure].
The specific configuration needs to include the following keys:
...
The `procedure_name` indicates that we mirror the behaviour of the existing xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-single-relationship-property-example[procedure].
The specific configuration needs to include the following keys:
...
The `procedure_name` indicates that we mirror the behaviour of the existing xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-relationship-properties-example[procedure].
The specific configuration needs to include the following keys:
...
The `procedure_name` indicates that we mirror the behaviour of the existing xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-relationship-topology-example[procedure].
The specific configuration needs to include the following keys:
