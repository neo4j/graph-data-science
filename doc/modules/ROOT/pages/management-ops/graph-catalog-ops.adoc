...
- a xref:management-ops/projections/graph-project-cypher.adoc[Legacy Cypher projection]
- or a xref:management-ops/projections/graph-project-cypher-aggregation.adoc[Cypher projection]
...
| xref:management-ops/projections/graph-project-cypher.adoc[gds.graph.project.cypher]            | Adds a graph to the catalog using Legacy Cypher projection.
| xref:management-ops/projections/graph-project-cypher-aggregation.adoc[gds.graph.project]       | Adds a graph to the catalog using Cypher projection.
