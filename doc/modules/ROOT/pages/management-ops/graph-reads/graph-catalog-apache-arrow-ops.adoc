...
Those are documented in xref:management-ops/graph-reads/graph-stream-nodes.adoc[Streaming nodes] and xref:management-ops/graph-reads/graph-stream-relationships.adoc[Streaming Relationship].
