...
| xref:common-usage/running-algos.adoc#common-configuration-jobid[jobId] | String | Generated internally | yes | An ID that can be provided to more easily track the progress.
|===
...
image::example-graphs/node-similarity.svg[Visualization of the example graph,450,role=popup]
