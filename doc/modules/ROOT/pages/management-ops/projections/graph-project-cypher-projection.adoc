...
Cypher projections are a more flexible and expressive approach with diminished focus on performance compared to the xref:management-ops/graph-creation/graph-project.adoc[native projections].
