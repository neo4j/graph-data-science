...
Achieving the reverse orientation can be achieved by simply switched the source and target nodes.
...
To project relationships as undirected, you can specify the `undirectedRelationshipTypes` parameter.
