...
The replacement is to use the new Cypher projection, which is described in xref:management-ops/projections/graph-project-cypher-aggregation.adoc[Projecting graphs using Cypher].
--
