...
| memory label:serverless[Aura Graph Analytics Serverless]      | String                | -  | <not for Serverless>                  | Declare the memory used for the xref:installation/aura-graph-analytics-serverless.adoc[GDS Session] created for the projected graph.
