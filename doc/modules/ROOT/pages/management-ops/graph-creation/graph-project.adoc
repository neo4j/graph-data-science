...
NOTE: To get information about a previously projected graph, such as its schema, one can use xref:management-ops/inspecting-the-graph-catalog.adoc#catalog-graph-list[gds.graph.list].
