...
include::partial$/algorithms/common-configuration/common-read-configuration.adoc[]
| nodeProperties         | String, List or Map   | {}                   | yes | The node properties to load from nodes that match _any_ of the labels specified in `nodeProjection`.
| relationshipProperties | String, List or Map   | {}                   | yes | The relationship properties to load from relationships that match _any_ of the types specified in `relationshipProjection`.
