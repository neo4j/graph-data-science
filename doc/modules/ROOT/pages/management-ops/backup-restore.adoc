...
| useLabelMapping | Boolean | true    | Flag to decide whether to use node label mapping when exporting the graph. See xref:management-ops/graph-export/graph-export-csv.adoc#node_label_mapping[exporting graphs to csv] for details.
|===
