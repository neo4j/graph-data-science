...
.Configuration
[opts="header",cols="1,1,1,1,7"]
|===
| Name                   | Type                  | Default           | Optional | Description
include::partial$/algorithms/common-configuration/concurrency-entry.adoc[]
| writeConcurrency       | Integer               | 'concurrency'     | yes | The number of concurrent threads used for writing the relationship properties. Note, this procedure is always running single-threaded.
|===
...
image::example-graphs/node-similarity.svg[Visualization of the example graph,400,role=popup]
...
image::example-graphs/write-relationships-graph.svg[Visualization of the example graph after writing relationships back,400,role=popup]
...
image::example-graphs/write-relationship-properties.svg[Visualization of the example graph,400,role=popup]
