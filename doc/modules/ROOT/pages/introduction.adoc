...
These values can represent _cost_, _time_, _capacity_ or some other domain-specific property, specified via the xref::common-usage/running-algos.adoc#common-configuration-node-weight-property[nodeWeightProperty] and xref::common-usage/running-algos.adoc#common-configuration-relationship-weight-property[relationshipWeightProperty] configuration parameters.
...
** Supports an xref::production-deployment/feature-toggles.adoc#bit-id-map-feature-toggle[optimized in-memory graph implementation]
