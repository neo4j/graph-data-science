...
| sessionInfo label:serverless[Aura Graph Analytics]    | String or Map     | n/a     | no       | The name of the xref:aura-graph-analytics/index.adoc[GDS Session] the model should be dropped from. Accepts the output of the helper function `sessionInfo`.
