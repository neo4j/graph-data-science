...
| sessionInfo label:serverless[Aura Graph Analytics]    | String or Map     | n/a     | no       | The name of the xref:aura-graph-analytics/index.adoc[GDS Session] which holds the model. Accepts the output of the helper function `sessionInfo`.
