...
* xref::algorithms/graph-sage.adoc[GraphSAGE model]
* xref::algorithms/ml-models/node-classification.adoc[Node Classification model]
* xref::algorithms/ml-models/linkprediction.adoc[Link Prediction model]


*Models that cannot be stored*

* xref::algorithms/ml-models/linkprediction-pipelines.adoc[Link prediction training pipeline]
* xref::algorithms/ml-models/linkprediction-pipelines.adoc#algorithms-ml-linkprediction-pipelines-train[Link prediction pipeline]
