...
* xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[Node Classification model]
* xref::machine-learning/linkprediction-pipelines/index.adoc[Link Prediction model]

For xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[Node Classification] and xref::machine-learning/linkprediction-pipelines/index.adoc[Link Prediction], storing a model is only supported for a subset of xref::machine-learning/training-methods/index.adoc[trainer-methods].
