...
----
CALL gds.model.list([ sessionInfo: String or Map, ] modelName: String)
YIELD
    modelName: String,
    modelType: String,
    modelInfo: Map,
...
| sessionInfo label:serverless[Aura Graph Analytics]    | String or Map     | n/a     | no       | The name of the xref:aura-graph-analytics/index.adoc[GDS Session] from which the models are listed. Accepts the output of the helper function `sessionInfo`.
