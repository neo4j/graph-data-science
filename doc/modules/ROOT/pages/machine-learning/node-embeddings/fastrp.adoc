...
You can write the embeddings to node properties, create a link:https://neo4j.com/docs/cypher-manual/current/indexes/semantic-indexes/vector-indexes/[vector index] in the Neo4j database over that property, and query it with Cypher.
