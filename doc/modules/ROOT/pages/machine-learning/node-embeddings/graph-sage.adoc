...
Since training GraphSAGE may take a lot of time and memory to train on large graphs, it can be helpful to sample a smaller subgraph prior to training, and then training on that subgraph.
