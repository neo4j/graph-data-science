...
To sample a structurally representative subgraph, see xref:management-ops/graph-creation/sampling/rwr.adoc[Random walk with restarts sampling].
...
The `projectedFeatureDimension` should equal the maximum length of the feature-array.
In our example, persons have `age` (1) and `heightAndWeight` (2), summing up to a length of 3.
Instruments only have `cost` with length of 1. 
Thus, the `projectedFeatureDimension` should be set to 3.
...
|===
| nodeId | embedding
| 0      | [0.528500257482333, 0.468218186911235, 0.708137844620235]
| 1      | [0.528500257482782, 0.468218186911469, 0.708137844619745]
| 2      | [0.528500257482316, 0.468218186911227, 0.708137844620253]
| 3      | [0.528500257480933, 0.468218186910508, 0.708137844621761]
| 4      | [0.528500257525252, 0.468218186933538, 0.708137844573457]
| 5      | [0.528500257587681, 0.468218186965977, 0.708137844505415]
| 6      | [0.528500257481127, 0.468218186910609, 0.708137844621549]
|===
--
