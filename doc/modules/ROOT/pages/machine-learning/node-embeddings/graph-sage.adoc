...
[source, cypher, role=noplay query-example, no-result=true, indent=0]
----
CALL gds.beta.graphSage.train(
  'persons_with_instruments',
  {
...
[source, cypher, role=noplay query-example, no-result=true, group=noProps, indent=0]
----
...
[source, cypher, role=noplay query-example, no-result=true, group=graphSage, indent=0]
----
CALL gds.beta.graphSage.train(
  'persons',
  {
