...
The `projectedFeatureDimension` equals the maximum length of the feature-array, i.e., for persons `age` (1) and `heightAndWeight` (2) sum up to a length of 3 and instruments with only cost leads to a length of 1. Thus, the `projectedFeatureDimension` should be set to 3.
