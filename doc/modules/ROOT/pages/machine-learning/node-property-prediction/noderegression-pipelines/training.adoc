...
image::example-graphs/node-property-pipeline-graph.svg[align="center"]

.The following Cypher statement will create the example graph in the Neo4j database:
[source, cypher, role=noplay setup-query, group=nr]
----
CREATE
...
We do this using a Cypher projection targeting the `House` and `UnknownHouse` labels.
...
|===
| winningModel                                                                                                                                | avgTrainScore | outerTrainScore    | testScore
| {maxDepth=2147483647, methodName="RandomForest", minLeafSize=1, minSplitSize=2, numberOfDecisionTrees=5, numberOfSamplesRatio=1.0} | 758.087008266667 | 837.5558960000001 | 1192.523748
|===
--
