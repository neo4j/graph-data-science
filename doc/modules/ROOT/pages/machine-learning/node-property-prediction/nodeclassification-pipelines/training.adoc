...
| {maxEpochs=500, minEpochs=1, penalty=5.881039653970664, patience=1, methodName=LogisticRegression, batchSize=100, tolerance=0.001, learningRate=0.001} | 0.999999989939394 | 0.999999991212121 | 0.999999985 | [0.41818181190909104, 0.0, 0.4909090835454547, 0.41818181190909104]
|===

Here we can observe that the model candidate with penalty `5.881` performed the best in the training phase, with an `F1_WEIGHTED` score nearing 1 over the train graph as well as on the test graph.
