...
We still train a model to predict the class of each house, but additionally use the Painter information to generate new node properties and features that the model uses in training.
