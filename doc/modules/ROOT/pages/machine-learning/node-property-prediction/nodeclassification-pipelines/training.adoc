...
| {maxEpochs=100, minEpochs=1, penalty=0.0, patience=1, methodName=LogisticRegression, batchSize=100, tolerance=0.001, learningRate=0.001} | 0.999999989393939 | 0.999999990909091 | 0.636363628636364 | [0.5454545372727274, 0.23030302698989905, 0.2484848448383839, 0.5454545372727274, 0.5454545372727274]
|===
