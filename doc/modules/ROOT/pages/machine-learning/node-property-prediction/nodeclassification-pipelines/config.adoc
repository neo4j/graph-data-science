...
| "pipe"   | [{name=gds.beta.scaleProperties.mutate, config={scaler=Mean, contextRelationshipTypes=[], contextNodeLabels=[], mutateProperty=scaledSizes, nodeProperties=sizePerStory}}]
|===
