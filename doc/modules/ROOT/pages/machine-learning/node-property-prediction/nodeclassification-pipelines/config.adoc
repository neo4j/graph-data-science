...
[source, cypher, role=noplay]
----
CALL gds.beta.pipeline.nodeClassification.addNodeProperty('pipe', 'beta.scaleProperties', {
...
[source, cypher, role=noplay]
----
CALL gds.pipeline.nodeClassification.addRandomForest(
  pipelineName: String,
  config: Map
)
YIELD
...
--
CALL gds.pipeline.nodeClassification.addRandomForest('pipe', {numberOfDecisionTrees: 5})
YIELD parameterSpace
--
