...
CALL gds.beta.pipeline.nodeClassification.addNodeProperty(
  ...
  contextNodeLabels: List of String,
  contextRelationshipTypes: List of String
)
YIELD
  name: String,
  nodePropertySteps: List of Map,
...
| contextNodeLabels         | List of String     | contextNodeLabels.
| contextRelationshipTypes  | List of String     | contextRelationshipTypes.
|===
