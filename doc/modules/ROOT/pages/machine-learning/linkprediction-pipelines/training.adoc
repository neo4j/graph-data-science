...
| {batchSize=100, classWeights=[0.55, 0.45], focusWeight=0.0904839039, hiddenLayerSizes=[4, 2], learningRate=0.001, maxEpochs=100, methodName="MultilayerPerceptron", minEpochs=1, patience=2, penalty=0.5, tolerance=0.001}
| 0.8584656085
| 0.82
| 0.6777777778
| [0.5555555556, 0.5277777778, 0.4305555556, 0.875]
|===
--
