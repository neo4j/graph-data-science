...
| sourceNodeLabel                                               | String            | n/a                  | no       | The name of the node label a relationship in the training set should start from footnote:label-filter[This helps to train the model to predict links with a certain label combination.].
| targetNNodeLabel                                              | String            | n/a                  | no       | The name of the node label a relationship in the training set should end at footnote:label-filter[].
