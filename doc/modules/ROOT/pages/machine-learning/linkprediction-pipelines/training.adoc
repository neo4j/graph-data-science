...
| {maxDepth=2147483647, minLeafSize=1, criterion=GINI, minSplitSize=2, numberOfDecisionTrees=10, methodName=RandomForest, numberOfSamplesRatio=1.0} | 0.698677248677249 |  0.788888888888889 | 0.766666666666667 | [0.3333333333333333, 0.861111111111111, 0.3333333333333333, 0.3333333333333333]
|===
