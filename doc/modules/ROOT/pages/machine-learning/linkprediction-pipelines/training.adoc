...
| {maxEpochs=100, minEpochs=1, penalty=1.0, patience=2, methodName=MultilayerPerceptron, focusWeight=0.0, hiddenLayerSizes=[4, 2], batchSize=100, tolerance=0.001, learningRate=0.001} | 0.696626984126984 |  0.75 | 0.75 | [0.736111111111111, 0.5833333333333334, 0.861111111111111, 0.736111111111111, 0.736111111111111]
|===
--
We can see the MLP model configuration won, and has a score of `0.75` on the test set.
...
|===
| winningModel                                                                                                                                | avgTrainScore      | outerTrainScore     | testScore | validationScores
| {maxEpochs=100, minEpochs=1, penalty=1.0, patience=2, methodName=MultilayerPerceptron, focusWeight=0.0, hiddenLayerSizes=[4, 2], batchSize=100, tolerance=0.001, learningRate=0.001} | 0.696626984126984 |  0.75 | 0.75 | [0.861111111111111]
|===
--
