...
| targetRelationshipType                                        | String            | n/a                  | no       | The name of the relationship type to train the model on.
