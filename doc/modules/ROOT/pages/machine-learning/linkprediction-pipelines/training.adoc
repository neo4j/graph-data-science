...
| {maxEpochs=100, minEpochs=1, penalty=1.0, patience=2, methodName=MultilayerPerceptron, focusWeight=0.0, hiddenLayerSizes=[4, 2], batchSize=100, tolerance=0.001, learningRate=0.001} | 0.858465608465608 |  0.82 | 0.677777777777778 | [0.5555555555555555, 0.4444444444444444, 0.875, 0.4305555555555555, 0.4305555555555555]
|===
--
...
|===
| winningModel                                                                                                                                | avgTrainScore      | outerTrainScore     | testScore | validationScores
| {maxEpochs=100, minEpochs=1, penalty=1.0, patience=2, methodName=MultilayerPerceptron, focusWeight=0.0, hiddenLayerSizes=[4, 2], batchSize=100, tolerance=0.001, learningRate=0.001} | 0.858465608465608 |  0.82 | 0.677777777777778 | [0.875]
|===
--
