...
We will attempt to train a model to predict which people might know each other.
...
We ignore the additional nodes and relationship types, in order for our projection to be mono-partite.
