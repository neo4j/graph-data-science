...
|===
| winningModel                                                                                                                                | avgTrainScore      | outerTrainScore     | testScore | validationScores
| {maxEpochs=100, minEpochs=1, penalty=1.0, patience=2, methodName=MultilayerPerceptron, hiddenLayerSizes=[4, 2], batchSize=100, tolerance=0.001, learningRate=0.001} | 0.799603174603175 |  0.8 | 0.75 | [0.5555555555555555, 0.7222222222222222, 0.75, 0.5555555555555555, 0.5555555555555555]
|===
--

As we can see the validation score increases slightly for one of the folds.
This is due to the embeddings taking into account more contextual information.
