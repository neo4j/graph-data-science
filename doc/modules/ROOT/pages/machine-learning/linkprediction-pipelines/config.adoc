...
For information about the available training methods in GDS, logistic regression and random forest, see xref::machine-learning/training-methods/index.adoc[Training methods].
