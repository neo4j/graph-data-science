...
| "Alice"   | "Chris"   | 0.6207332784
| "Mark"    | "Chris"   | 0.5986795167
| "Mark"    | "Alice"   | 0.5662968371
| "Alice"   | "Karin"   | 0.5607462866
| "Alice"   | "Greg"    | 0.5579582123
|===
...
|===
| relationshipsWritten | samplingStats
| 16                   | {didConverge=true, linksConsidered=56, ranIterations=3, strategy="approximate"}
|===
--

As we can see in the `samplingStats`, we use the approximate search strategy and check 56 possible links during the prediction.
...
|===
| person1   | person2   | probability
| "Alice"   | "Chris"   | 0.7174928596
| "Mark"    | "Chris"   | 0.6573294858
| "Mark"    | "Alice"   | 0.5617915136
| "Alice"   | "Karin"   | 0.54489345
| "Alice"   | "Greg"    | 0.5364068805
|===
