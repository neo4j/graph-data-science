...
Additionally, we will project a few graphs to the graph catalog, for more details see xref:management-ops/projections/graph-project.adoc[native projections] and xref:management-ops/projections/graph-project-cypher-projection.adoc[Cypher projections].
