...
Additionally, we will project a few graphs to the graph catalog, for more details see xref::graph-project.adoc[native projections] and xref::graph-project-cypher.adoc[Cypher projections].
