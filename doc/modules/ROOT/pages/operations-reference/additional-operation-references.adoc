...
| xref:management-ops/create-cypher-db.adoc[Create an impermanent database backed by a projected graph] | `gds.ephemeral.database.create`
...
| xref:management-ops/create-cypher-db.adoc#drop-ephemeral-db[Drop an impermanent database backed by a projected graph] | `gds.ephemeral.database.drop`
| xref:management-ops/create-cypher-db.adoc#drop-ephemeral-db[Drop an impermanent database backed by a projected graph] | `gds.alpha.drop.cypherdb` (deprecated)
