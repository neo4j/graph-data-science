...
| xref:management-ops/graph-reads/create-cypher-db.adoc[Create an impermanent database backed by a projected graph] | `gds.ephemeral.database.create` label:procedure[Procedure] (deprecated)
