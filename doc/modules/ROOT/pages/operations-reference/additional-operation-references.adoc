...
| xref:management-ops/graph-inspection/graph-streaming.adoc#utility-functions-catalog[Accessing a node property in a named graph] | `gds.util.nodeProperty` label:function[Function]
