...
|===
|Algorithm name | Operation
.3+<.^| xref::machine-learning/linkprediction-pipelines/index.adoc[Link Prediction Pipeline]
...
.3+<.^| xref::machine-learning/node-property-prediction/nodeclassification-pipelines/index.adoc[Node Classification Pipeline]
