...
| `gds.alpha.pipeline.linkPrediction.addRandomForest` label:procedure[Procedure] (deprecated)
...
| `gds.alpha.pipeline.nodeClassification.addRandomForest` label:procedure[Procedure] (deprecated)
