...
.6+<.^|xref:alpha-algorithms/minimum-weight-spanning-tree.adoc[Spanning Tree]
...
.2+<.^|xref:alpha-algorithms/k-minimum-weight-spanning-tree.adoc[ k-Spanning Tree]
...
.8+<.^| xref:algorithms/alpha/leiden.adoc[Leiden]
