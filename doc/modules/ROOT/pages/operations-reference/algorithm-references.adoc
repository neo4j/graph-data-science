...
.6+<.^| xref::algorithms/delta-single-source.adoc[All Shortest Paths Delta-Stepping]
...
.4+<.^|xref::algorithms/bfs.adoc[BFS]
| `gds.bfs.mutate`
...
.11+<.^| xref::machine-learning/linkprediction-pipelines.adoc[Link Prediction Pipeline]
...
.13+<.^| xref::machine-learning/nodeclassification-pipelines.adoc[Node Classification Pipeline]
...
[opts=header,cols="1, 2"]
|===
|Algorithm name | Operation .1+<.^|xref::alpha-algorithms/all-pairs-shortest-path.adoc[All Shortest Paths]
...
.1+<.^| xref::machine-learning/linkprediction-pipelines.adoc[Link Prediction Pipeline]
| `gds.alpha.pipeline.linkPrediction.addRandomForest`
.1+<.^| xref::machine-learning/nodeclassification-pipelines.adoc[Node Classification Pipeline]
