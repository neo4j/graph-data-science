...
.8+<.^|xref:algorithms/scale-properties.adoc[Scale Properties]
...
| `_gds.similarity.cosine_`
| `_gds.similarity.euclidean_`
| `_gds.similarity.euclideanDistance_`
| `_gds.similarity.jaccard_`
| `_gds.similarity.overlap_`
| `_gds.similarity.pearson_`
...
| xref:alpha-algorithms/resource-allocation.adoc[Resource Allocation] | `_gds.alpha.linkprediction.resourceAllocation_`
...
.2+<.^|xref:algorithms/scale-properties.adoc[Scale Properties]
| `gds.alpha.scaleProperties.mutate` (deprecated)
| `gds.alpha.scaleProperties.stream` (deprecated)
|===
