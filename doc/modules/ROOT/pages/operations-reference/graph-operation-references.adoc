...
.2+<.^|xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-single-node-property-example[Stream a single node property to the procedure caller]
...
.2+<.^|xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-node-properties-example[Stream node properties to the procedure caller]
...
.2+<.^|xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-single-relationship-property-example[Stream a single relationship property to the procedure caller]
...
.3+<.^|xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-relationship-properties-example[Stream relationship properties to the procedure caller]
...
.2+<.^|xref:management-ops/graph-write-to-neo4j/partial-write-back.adoc#catalog-graph-write-node-properties-example[Write node properties to Neo4j]
| `gds.graph.nodeProperties.write` label:procedure[Procedure]
| `gds.graph.writeNodeProperties` label:procedure[Procedure]
.2+<.^|xref:management-ops/graph-write-to-neo4j/partial-write-back.adoc#catalog-graph-write-relationship-example[Write relationships to Neo4j]
| `gds.graph.relationship.write` label:procedure[Procedure]
| `gds.graph.writeRelationship` label:procedure[Procedure]
|xref:management-ops/graph-catalog-export-ops.adoc#catalog-graph-export-database[Graph Export] | `gds.graph.export` label:procedure[Procedure]
|===
...
.2+<.^|xref:management-ops/graph-catalog-export-ops.adoc#catalog-graph-export-csv[CSV Export]
| `gds.beta.graph.export.csv` label:procedure[Procedure]
| `gds.beta.graph.export.csv.estimate` label:procedure[Procedure]
|xref:management-ops/graph-inspection/graph-streaming.adoc#catalog-graph-stream-relationship-topology-example[Stream relationship topologies to the procedure caller] | `gds.beta.graph.relationships.stream` label:procedure[Procedure]
...
|xref:management-ops/graph-write-to-neo4j/partial-write-back.adoc#catalog-graph-write-node-label-example[Write node labels to the database]         | `gds.alpha.graph.nodeLabel.write` label:procedure[Procedure]
|===
