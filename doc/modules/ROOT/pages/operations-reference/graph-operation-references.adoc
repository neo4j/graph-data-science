...
| `gds.graph.project.cypher` label:procedure[Procedure] (deprecated)
| `gds.graph.project.cypher.estimate` label:procedure[Procedure] (deprecated)
...
| `gds.graph.removeNodeProperties` label:procedure[Procedure] (deprecated)
...
| `gds.graph.deleteRelationships` label:procedure[Procedure] (deprecated)
...
| `gds.graph.streamNodeProperty`  label:procedure[Procedure] (deprecated)
...
| `gds.graph.streamNodeProperties`  label:procedure[Procedure] (deprecated)
...
| `gds.graph.streamRelationshipProperty`  label:procedure[Procedure] (deprecated)
...
| `gds.graph.streamRelationshipProperties`  label:procedure[Procedure] (deprecated)
