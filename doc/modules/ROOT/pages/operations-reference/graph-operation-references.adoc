...
|xref:management-ops/graph-write-to-neo4j/write-back-whole-graph.adoc#catalog-graph-export-database[Graph Export] | `gds.graph.export` label:procedure[Procedure]
|===
