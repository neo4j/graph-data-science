...
|===
|Description                                | Operation
|xref:management-ops/graph-creation/graph-project-subgraph.adoc[Project a graph from a graph in the catalog] | `gds.graph.project.subgraph` label:procedure[Procedure]
