...
[NOTE]
====
If the file is not available on the Deployment Center, download it from link:https://graphdatascience.ninja/neo4j-graph-data-science-2.13.9.zip[this link].
====
