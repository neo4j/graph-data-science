...
For using Arrow Flight with an Arrow client, please refer to our documentation for xref:management-ops/graph-creation/graph-project-apache-arrow.adoc[projecting graphs] and xref:management-ops/graph-inspection/graph-catalog-apache-arrow-ops.adoc[streaming properties].
