...
* For xref:management-ops/projections/graph-project-cypher-legacy.adoc[Legacy Cypher projections], a higher page cache is required depending on the query complexity.
* For xref:management-ops/projections/graph-project-cypher-aggregation.adoc[Cypher projections], a higher page cache is required depending on the query complexity.
