...
* For xref:management-ops/projections/graph-project-cypher-projection.adoc[Cypher projections], a higher page cache is required depending on the query complexity.
