...
* If you are new to Neo4j, a convenient option to get started is to install a version of the  https://neo4j.com/docs/desktop-manual/current/installation/[Neo4j Desktop] application first.
You can then install the GDS library directly xref:installation/neo4j-desktop.adoc[from the UI]
...
NOTE: Skip this section if you use Aura Graph Analytics.
