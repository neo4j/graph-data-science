...
[source, cypher]
----
CALL algo.shortestPath.deltaStepping(startNode:Node, relationshipWeightProperty:String, delta:Float,
...
[source, cypher]
----
CALL algo.shortestPath.deltaStepping.stream(startNode:Node, relationshipWeightProperty:String, delta: Float,
...
| Name   | Type | Description
| nodeId | int  | Node ID
| cost   | int  | The cost it takes to get from the start node to the specific node
|===
...
** direction: 'OUTGOING' or INCOMING, relationshipWeightProperty: null
* [x] directed, weighted
** direction: 'OUTGOING' or INCOMING, relationshipWeightProperty: 'cost'
* [x] undirected, unweighted
** direction: 'BOTH', relationshipWeightProperty: null
* [x] undirected, weighted
** direction: 'BOTH', relationshipWeightProperty: 'cost'
