...
The training process uses a logistic regression algorithm, and the evaluation uses the <<linkprediction-pipelines-metrics, AUCPR metric>>.
...
| {maxEpochs=100, minEpochs=1, penalty=0.0625, patience=1, batchSize=100, tolerance=0.001} | 0.3721560846560847 |  0.3801587301587301 | 0.7638888888888888
|===
