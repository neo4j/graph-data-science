...
| {RandomForestClassification=[], LogisticRegression=[]}
|===
--
...
YIELD parameterSpace
RETURN parameterSpace.RandomForestClassification AS randomForestSpace, parameterSpace.LogisticRegression AS logisticRegressionSpace
----
