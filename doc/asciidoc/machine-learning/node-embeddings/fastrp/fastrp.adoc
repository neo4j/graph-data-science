...
:homogeneous:
:weighted:
include::../../../algorithms/shared/algorithm-traits.adoc[]
...
Moreover, in GDS it is possible to use node properties for the creation of these _initial random vectors_ in a way described <<algorithms-embeddings-fastrp-examples-properties,below>>.
...
include::../../../algorithms/shared/syntax-intro-named-graph.adoc[]
...
include::../../../algorithms/common-configuration/common-stream-stats-configuration-entries.adoc[]
...
|===
| Name          | Type   | Default | Optional | Description
include::../../../algorithms/common-configuration/common-mutate-configuration-entries.adoc[]
include::specific-configuration.adoc[]
|===
...
|===
| Name          | Type   | Default | Optional | Description
include::../../../algorithms/common-configuration/common-write-configuration-entries.adoc[]
include::specific-configuration.adoc[]
|===
...
include::../../../algorithms/shared/examples-stream-intro.adoc[]
...
include::../../../algorithms/shared/examples-stats-intro.adoc[]
...
include::../../../algorithms/shared/examples-mutate-intro.adoc[]
...
include::../../../algorithms/shared/examples-write-intro.adoc[]
