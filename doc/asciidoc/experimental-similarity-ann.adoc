...
CALL algo.ml.ann.stream("jaccard", data, {similarityCutoff: 0.1})
...
WITH {item:id(p), categories: collect(id(cuisine))} as userData
WITH collect(userData) as data
CALL algo.ml.ann("jaccard", data, {similarityCutoff: 0.1, showComputations: true, write: true})
...
[source, cypher]
----
CALL algo.ml.ann(userData:List<Map>, {
...
[source,cypher]
----
CALL algo.ml.ann.stream(userData:List<Map>, {
