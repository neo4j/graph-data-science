...
** <<algorithms-connected-components-example-seeding, Using seed communities>>
...
[[algorithms-connected-components-example-seeding]]
...
It can also potentially speed up the computation.
...
| config            | map     | n/a            | yes      | Additional configurations
|===
...
| Heavy | 1,632,803 | 30,622,564 | 421 MiB | 222 MiB   | 199 MiB
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 11,474,730 | 116,601,029 | 2468 MiB | 1067 MiB | 1400 MiB
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 41,652,230 | 1,468,365,182 | 12843 MiB  | 7759 MiB    | 5084 MiB
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 65,608,366 | 1,806,067,135 | 18 GiB  | 10545 MiB  | 8008 MiB
