...
| train                   | G: Graph, +
                            config: **kwargs       | NCPredictionPipeline, +
                                                             dict[str, any] | <<algorithms-ml-nodeclassification-pipelines-train, Train the pipeline on the given input graph using given keyword arguments>>.
| train_estimate          | G: Graph, +
                            config: **kwargs       | dict[str, any]         | <<algorithms-ml-nodeclassification-examples-train-memory-estimation, Estimate training the pipeline on the given input graph using given keyword arguments>>.
...
| predict_mutate_estimate | G: Graph, +
                            config: **kwargs | dict[str, any]       | <<algorithms-ml-nodeclassification-examples-predict-memory-estimation, Estimate predicting classes for nodes of the input graph and mutating graph with predictions>>.
...
| predict_stream_estimate | G: Graph, +
                            config: **kwargs | dict[str, any]       | <<algorithms-ml-nodeclassification-examples-predict-memory-estimation, Estimate predicting classes for nodes of the input graph and streaming the results>>.
...
| predict_write_estimate  | G: Graph, +
                            config: **kwargs | dict[str, any]       | <<algorithms-ml-nodeclassification-examples-predict-memory-estimation, Estimate predicting classes for nodes of the input graph and writing the results back to the database>>.
...
| train_estimate      | G: Graph, +
                        config: **kwargs       | dict[str, any]          | <<algorithms-ml-linkprediction-pipeline-examples-train-estimate, Estimate training the pipeline on the given input graph using given keyword arguments>>.
| node_property_steps | -                      | list[dict[str, any]]    | Returns the node property steps of the pipeline.
