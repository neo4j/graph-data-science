...
| addLogisticRegression | parameter_space: +
                            dict[str, any]         | Series                  | <<nodeclassification-pipelines-configure-model-parameters, Add a logistic regression model configuration to train as a candidate in the model selection phase>>.
| addRandomForest       | parameter_space: +
                            dict[str, any]         | Series                  | <<nodeclassification-pipelines-configure-model-parameters, Add a random forest model configuration to train as a candidate in the model selection phase>>.
| train                 | G: Graph, +
...
| addLogisticRegression | parameter_space: +
                          dict[str, any]         | Series              | <<linkprediction-configure-model-parameters, Add a logistic regression model configuration to train as a candidate in the model selection phase>>.
| addRandomForest       | parameter_space: +
                          dict[str, any]         | Series              | <<linkprediction-configure-model-parameters, Add a random forest model configuration to train as a candidate in the model selection phase>>.
| train                 | G: Graph, +
