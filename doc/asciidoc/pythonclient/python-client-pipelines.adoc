...
| configureParams         | parameter_space: +
                            list[dict[str, any]]   | dict[str, any]         | <<nodeclassification-pipelines-configure-model-parameters, Configure the model parameter space used during the model selection phase>>.
| train                   | G: Graph, +
...
| configureParams     | parameter_space: +
                        list[dict[str, any]]   | dict[str, any]          | <<linkprediction-configure-model-parameters, Configure the model parameter space used during the model selection phase>>.
| train               | G: Graph, +
