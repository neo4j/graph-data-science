...
| train                   | G: Graph, +
                            config: **kwargs       | NCPredictionPipeline | <<algorithms-ml-nodeclassification-pipelines-train, Train the model on the given input graph using given keyword arguments>>.
...
| train               | G: Graph, +
                        config: **kwargs       | LPPredictionPipeline | <<algorithms-ml-linkprediction-pipelines-train, Train the model on the given input graph using given keyword arguments>>.
| node_property_steps | -                      | list[dict[str, any]] | Returns the node property steps of the pipeline.
