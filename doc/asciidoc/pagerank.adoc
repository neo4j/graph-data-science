...
PageRank is a variant of <<experimental-algorithms-eigenvector, Eigenvector Centrality>>.
// end::introduction[]
...
* <<algorithms-pagerank-memory-requirements, Memory Requirements>>
...
[[algorithms-pagerank-example-tolerance]]
=== Tolerance

The PageRank algorithm accepts a tolerance value.
When the rank computation stabilizes and changes are smaller than the tolerance value the algorithm will reuturn.
...
| graph             | string  | 'heavy'                   | yes      | Use 'huge' when describing the subset of the graph with label and relationship-type parameter. Use 'cypher' for describing the subset with cypher node-statement and relationship-statement.
|===
...
[[algorithms-pagerank-memory-requirements]]
== Memory Requirements for the PageRank algorithm
:algorithm: "pageRank"

We can use the <<algo-memrec-procedure>> to compute the memory requirements of running graph algorithms.

.The following returns the memory requirements for running PageRank on the Heavy Graph:
:graph: "heavy"
...
.The following returns the memory requirements for running PageRank on the Huge Graph:
:graph: "huge"
include::memrec.adoc[tags=overview]
...
.The following returns the memory break down for running PageRank on the Heavy Graph:
:graph: "heavy"
...
| PageRank   | 3648 Bytes
| HeavyGraph | 832 Bytes
|===

.The following returns the memory break down for running PageRank on the Huge Graph:
:graph: "huge"
include::memrec.adoc[tags=component]
...
| Heavy | 1,632,803 | 30,622,564 | 297 MiB| 222 MiB   | 74 MiB
| Huge | 1,632,803 | 30,622,564 | 	[149 MiB...205 MiB] | [74 MiB...130 MiB] | 74 MiB
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 11,474,730 | 116,601,029 | 1592 MiB | 1067 MiB | 525 MiB
| Huge | 11,474,730 | 116,601,029 | 	[963 MiB...1182 MiB] | [438 MiB...657 MiB] | 525 MiB
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 41,652,230 | 1,468,365,182 | 9665 MiB  | 7759 MiB    | 1906 MiB
| Huge | 41,652,230 | 1,468,365,182 | 	[4491 MiB...7272 MiB]  | [2584 MiB...5365 MiB]   | 1906 MiB
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 65,608,366 | 1,806,067,135 | 13549 MiB  | 10545 MiB   | 3003 MiB
| Huge | 65,608,366 | 1,806,067,135 | 	[6573 MiB...11642 MiB]  | [3570 MiB...8638 MiB]   | 3003 MiB
|===
