...
CREATE (about)-[:LINKS]->(home)
CREATE (product)-[:LINKS]->(home)
CREATE (home)-[:LINKS]->(product)
CREATE (links)-[:LINKS]->(home)
CREATE (home)-[:LINKS]->(links)
CREATE (links)-[:LINKS]->(a)
CREATE (a)-[:LINKS]->(home)
CREATE (links)-[:LINKS]->(b)
CREATE (b)-[:LINKS]->(home)
CREATE (links)-[:LINKS]->(c)
CREATE (c)-[:LINKS]->(home)
CREATE (links)-[:LINKS]->(d)
CREATE (d)-[:LINKS]->(home)
----
