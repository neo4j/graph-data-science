[[labs-algorithms-minimum-weight-spanning-tree]]
...
[WARNING]
--
The Minimum Weight Spanning Tree algorithm is part of Neo4j Labs and not supported for production purposes.
--
