...
The library uses multiple CPUs for graph projections, algorithm computation, and results writing.
Configuring the library to make best use of the available cores in your system is important to achieve maximum performance.
To find details on how to configure the concurrency of the GDS library, see <<algorithms-syntax-configuration-options>>.
