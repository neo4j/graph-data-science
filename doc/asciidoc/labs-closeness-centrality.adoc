[[labs-algorithms-closeness-centrality]]
...
[WARNING]
--
The Closeness Centrality algorithm is part of Neo4j Labs and not supported for production purposes.
--

This section includes:

* <<labs-algorithms-closeness-centrality-context, History and explanation>>
* <<labs-algorithms-closeness-centrality-usecase, Use-cases - when to use the Closeness Centrality algorithm>>
* <<labs-algorithms-closeness-centrality-limitations, Constraints - when not to use the Closeness Centrality algorithm>>
* <<labs-algorithms-closeness-centrality-sample, Closeness Centrality algorithm sample>>
* <<labs-algorithms-closeness-centrality-hgp, Huge graph projection>>
* <<labs-algorithms-closeness-centrality-cp, Cypher projection>>
* <<labs-algorithms-closeness-centrality-syntax, Syntax>>
* <<labs-algorithms-closeness-centrality-support, Graph type support>>


[[labs-algorithms-closeness-centrality-context]]
...
[[labs-algorithms-closeness-centrality-usecase]]
...
[[labs-algorithms-closeness-centrality-limitations]]
...
[[labs-algorithms-closeness-centrality-sample]]
...
[[labs-algorithms-closeness-centrality-hgp]]
...
[[labs-algorithms-closeness-centrality-cp]]
== Cypher projection
...
[[labs-algorithms-closeness-centrality-syntax]]
== Syntax
...
[[labs-algorithms-closeness-centrality-support]]
== Graph type support
