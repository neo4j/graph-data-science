[[labs-algorithms-triangle-count-clustering-coefficient]]
...
[WARNING]
--
The Triangle Counting / Cluster Coefficient algorithm is part of Neo4j Labs and not supported for production purposes.
--
