...
[source, cypher]
----
CALL gds.algo.nodeSimilarity.write(graphName: STRING, {
...
[source, cypher]
----
CALL gds.algo.nodeSimilarity.stream(graphName: STRING, {
  // configuration
})
...
[source, cypher]
----
CALL gds.algo.nodeSimilarity.stream({
...
[source, cypher]
----
CALL gds.algo.nodeSimilarity.write({
  nodeProjection: 'Person | Instrument',
  relationshipProjection: 'LIKES',
  direction: 'OUTGOING',
