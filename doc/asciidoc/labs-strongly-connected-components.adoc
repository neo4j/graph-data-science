[[labs-algorithms-strongly-connected-components]]
...
[WARNING]
--
The Strongly Connected Components algorithm is part of Neo4j Labs and not supported for production purposes.
--
