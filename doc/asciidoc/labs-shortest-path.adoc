...
[source, cypher]
----
CALL algo.shortestPath(startNode:Node, endNode:Node, relationshipWeightProperty:String
...
[source, cypher]
----
CALL algo.shortestPath.stream(startNode:Node, endNode:Node, relationshipWeightProperty:String
