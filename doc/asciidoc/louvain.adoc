...
[source,cypher]
----
CALL algo.memrec(null, null, "louvain", {graph: "huge", concurrency: 8})
...
[source,cypher]
----
CALL algo.memrec(null, null, "louvain", {graph: "heavy", concurrency: 8})
YIELD mapView
...
| Huge | 11,474,730 | 116,601,029 | 	[3086 MiB...4312 MiB] | [438 MiB...657 MiB] | [2538 MiB...3326 MiB]
|===
