...
* <<algorithms-louvain-memory-requirements, Memory Requirements>>
...
[[algorithms-louvain-memory-requirements]]
== Memory Requirements for the Louvain algorithm
:algorithm: "louvain"

We can use the <<algo-memrec-procedure>> to compute the memory requirements of running graph algorithms.

.The following returns the memory requirements for running Louvain on the Heavy Graph:
:graph: "heavy"
...
.The following returns the memory break down for running Louvain on the Heavy Graph:
:graph: "heavy"
...
| Heavy | 1,632,803 | 30,622,564 | [695 MiB...807 MiB]| 334 MiB    | [361 MiB...473 MiB]
| Huge | 1,632,803 | 30,622,564 | 	[465 MiB...693 MiB] | [104 MiB...219 MiB] | [361 MiB...473 MiB]
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 11,474,730 | 116,601,029 | [4043 MiB...4831 MiB] | 1505 MiB | [2538 MiB...3326 MiB]
| Huge | 11,474,730 | 116,601,029 | 	[3086 MiB...4312 MiB] | [547 MiB...985 MiB] | [2538 MiB...3326 MiB]
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 41,652,230 | 1,468,365,182 | [22 GiB...24 GiB]  | 13479 MiB    | [9215 MiB...12075 MiB]
| Huge | 41,652,230 | 1,468,365,182 | 	[13190 MiB...21 GiB]  | [3975 MiB...9536 MiB]    | [9215 MiB...12075 MiB]
|===
...
|===
| Graph Type | Nodes | Relationships | Required Memory | In Memory Graph | Algorithm
| Heavy | 65,608,366 | 1,806,067,135 | [31 GiB...35 GiB]  | 17 GiB    | [14516 MiB...18 GiB]
| Huge | 65,608,366 | 1,806,067,135 | 	[19 GiB...30 GiB]  | [5322 MiB...12205 MiB]    | [14516 MiB...18 GiB]
|===
