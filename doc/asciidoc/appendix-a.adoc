...
|===
| Algorithm | Procedure
.6+<.^|<<algorithms-label-propagation-syntax, Label Propagation>>
...
.6+<.^|<<algorithms-louvain-syntax, Louvain>>
| `gds.louvain.write`
...
.6+<.^|<<algorithms-node-similarity-syntax, Node Similarity>>
...
.6+<.^|<<algorithms-pagerank-syntax, PageRank>>
| `gds.pageRank.write`
...
.6+<.^|<<algorithms-wcc-syntax, Weakly Connected Components>>
| `gds.wcc.write`
...
.2+<.^|<<algorithms-node-similarity-syntax, Node Similarity>>
| `gds.beta.nodeSimilarity.mutate`
| `gds.beta.nodeSimilarity.mutate.estimate`
.2+<.^|<<algorithms-pagerank-syntax, PageRank>>
| `gds.beta.pageRank.mutate`
| `gds.beta.pageRank.mutate.estimate`
.2+<.^|<<algorithms-wcc-syntax, Weakly Connected Components>>
| `gds.beta.wcc.mutate`
