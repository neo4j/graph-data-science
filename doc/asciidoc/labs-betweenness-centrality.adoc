[[labs-algorithms-betweenness-centrality]]
...
[WARNING]
--
The Betweenness Centrality algorithm is part of Neo4j Labs and not supported for production purposes.
--
...
* <<labs-algorithms-betweenness-centrality-context, History and explanation>>
* <<labs-algorithms-betweenness-centrality-usecase, Use-cases - when to use the Betweenness Centrality algorithm>>
* <<labs-algorithms-betweenness-centrality-limitations, Constraints - when not to use the Betweenness Centrality algorithm>>
* <<labs-algorithms-betweenness-centrality-sample, Betweenness Centrality algorithm sample>>
* <<labs-algorithms-betweenness-centrality-approx, Approximation of Betweenness Centrality>>
** <<labs-algorithms-betweenness-centrality-ra_brandes, RA-Brandes algorithm>>
* <<labs-algorithms-betweenness-centrality-syntax, Syntax>>
* <<labs-algorithms-betweenness-centrality-cp, Cypher projection>>
* <<labs-algorithms-betweenness-centrality-support, Graph type support>>
* <<labs-algorithms-betweenness-centrality-imp, Implementations>>


[[labs-algorithms-betweenness-centrality-context]]
...
[[labs-algorithms-betweenness-centrality-usecase]]
...
[[labs-algorithms-betweenness-centrality-limitations]]
...
[[labs-algorithms-betweenness-centrality-sample]]
...
include::labs-betweenness-centrality-ra-brandes.adoc[leveloffset=3]


[[labs-algorithms-betweenness-centrality-cp]]
== Cypher projection
...
[[labs-algorithms-betweenness-centrality-support]]
== Graph type support
...
[[labs-algorithms-betweenness-centrality-imp]]
== Implementations
