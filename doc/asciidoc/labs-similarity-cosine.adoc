...
[abstract]
--
This section describes the Cosine Similarity algorithm in the Neo4j Labs Graph Algorithms library.
--
...
[WARNING]
--
The Cosine Similarity algorithm was developed by the Neo4j Labs team and is not officially supported.
--
...
[source, cypher]
----
CALL gds.alpha.similarity.cosine.write(graphNameOrConfig: STRING|MAP, configuration: MAP)
YIELD nodes, similarityPairs, write, writeRelationshipType, writeProperty, min, max, mean, stdDev, p25, p50, p75, p90, p95, p99, p999, p100
----
...
[source,cypher]
----
CALL gds.alpha.similarity.cosine.stream(graphNameOrConfig: STRING|MAP, configuration: MAP)
