...
In GDS we divide the our graph-algorithms into three different tiers.


[[production-quality-tier]]
== Production-quality tier

The following table lists all production-quality algorithms in the GDS library:
...
The following table lists all beta graph algorithms in the GDS library:

// TODO move to Utitlity procs
[role=procedure-listing]
[opts=header,cols="1, 1"]
|===
|Operation | Procedure
...
The following table lists all alpha algorithms in the GDS library:
