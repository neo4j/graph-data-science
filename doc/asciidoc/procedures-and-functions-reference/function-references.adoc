...
| <<alpha-algorithms-similarity-cosine, gds.alpha.similarity.cosine>>
| <<alpha-algorithms-similarity-jaccard, gds.alpha.similarity.jaccard>>
| <<alpha-algorithms-similarity-euclidean, gds.alpha.similarity.euclideanDistance>>
| `gds.alpha.similarity.euclidean`
| <<alpha-algorithms-similarity-overlap, gds.alpha.similarity.overlap>>
| <<alpha-algorithms-similarity-pearson, gds.alpha.similarity.pearson>>
|===
