...
[NOTE]
====
Using just a subset of the loaded relationships is currently only possible for a label and relationship-type projection.
====
...
[NOTE]
====
Loading multiple relationship properties is currently only supported for label and relationship type projections.
====
