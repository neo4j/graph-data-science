...
| nodeWeightProperty | string | The node property name that contains weight.
| relationshipWeightProperty | string | The relationship property name that contains weight.
|===
