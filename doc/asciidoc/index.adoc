...
These include experimental centrality and community algorithms, as well as experimental algorithms for link prediction, path finding and similarity.
The Neo4j Labs algorithms are documented in <<experimental-algorithms>>.
