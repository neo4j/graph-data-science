...
CALL gds.alpha.shortestPath.astar.stream(start, end, 'time', 'latitude', 'longitude', {defaultValue: 1.0})
YIELD nodeId, cost
...
----
MATCH (start:Station {name: "King's Cross St. Pancras"}), (end:Station {name: "Kentish Town"})
CALL gds.alpha.shortestPath.astar.stream(start, end, 'time', 'latitude', 'longitude', {
