[[labs-algorithms-degree-centrality]]
= The Degree Centrality algorithm

[abstract]
--
This section describes the Degree Centrality algorithm in the Neo4j Labs Graph Algorithms library.
--
...
[WARNING]
--
The Degree Centrality algorithm was developed by the Neo4j Labs team and is not officially supported.
--

This section includes:

* <<labs-algorithms-degree-context, History and explanation>>
* <<labs-algorithms-degree-usecase, Use-cases - when to use the Degree Centrality algorithm>>
* <<labs-algorithms-degree-sample, Degree Centrality algorithm sample>>
* <<labs-algorithms-degree-weighted-sample, Weighted Degree Centrality algorithm sample>>
* <<labs-algorithms-degree-hgp, Huge graph projection>>
* <<labs-algorithms-degree-cp, Cypher projection>>
* <<labs-algorithms-degree-syntax, Syntax>>


[[labs-algorithms-degree-context]]
...
[[labs-algorithms-degree-usecase]]
...
[[labs-algorithms-degree-weighted-sample]]
...
[[labs-algorithms-degree-syntax]]
== Syntax

.The following will run the algorithm and write back results:
[source, cypher]
----
CALL gds.alpha.degree.write(graphNameOrConfig: STRING|MAP, configuration: MAP)
...
[source, cypher]
----
CALL algo.degree.stream(graphNameOrConfig: STRING|MAP, configuration: MAP)
YIELD node, score
----
