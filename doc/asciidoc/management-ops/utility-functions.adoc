...
| gds.util.isFinite   | Return true if the given argument is a finite value (not ±Infinity, NaN, or null).
| gds.util.isInfinite | Return true if the given argument is not a finite value (not ±Infinity, NaN, or null).
|===
