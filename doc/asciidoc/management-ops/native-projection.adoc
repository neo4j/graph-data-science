...
* `NATURAL` is the default behaviour and projects relationships that are pointing away from a node, i.e., outgoing relationships.
* `REVERSE` projects relationships that are pointing towards a node, i.e., incoming relationships.
