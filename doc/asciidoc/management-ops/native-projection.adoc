...
CALL gds.pageRank.stats('my-graph', {nodeLabels: ['*']}) // will use all projected nodes
CALL gds.algo.mode('my-graph', {nodeLabels: ['Person', 'City', '*']}) // equivalent to above
CALL gds.algo.mode('my-graph') // equivalent to above
CALL gds.algo.mode('my-graph', {nodeLabels: ['Person']}) // will use only 'Person' nodes
CALL gds.algo.mode('my-graph', {nodeLabels: ['Person', 'City']}) // will use only 'Person' and 'City' nodes
----
