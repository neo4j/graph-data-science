...
[NOTE]
====
For certain Cypher patterns, the same behaviour can be achieved using the <<algorithms-traversal-to-relationship, Traversal to Relationship>> algorithm in combination with native projections.
====
