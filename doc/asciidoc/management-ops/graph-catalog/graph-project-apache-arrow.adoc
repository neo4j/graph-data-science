...
[NOTE]
====
In some situations the memory footprint of the loaded graph can be reduced by switching to another <<sharded-id-map-feature-toggle, id map implementation>>
====
