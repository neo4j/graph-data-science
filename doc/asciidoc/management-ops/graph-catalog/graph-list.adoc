...
| nodeFilter             | String   | The node filter used when projecting this subgraph from another projected graph. If the graph has been created from Neo4j, this will be `null`.
| relationshipFilter     | String   | The relationship filter used when projecting this subgraph from another projected graph. If the graph has been created from Neo4j, this will be `null`.
