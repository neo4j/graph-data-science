...
|===
| Name                                                                          | Description
| <<catalog-graph-create, gds.graph.project>>                                    | Creates a graph in the catalog using Native projection.
| <<catalog-graph-create-cypher, gds.graph.project.cypher>>                      | Creates a graph in the catalog using Cypher projection.
