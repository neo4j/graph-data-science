...
Named graphs can be created using either a <<catalog-graph-create, Native projection>> or a <<cypher-projection, Cypher projection>>.
...
|===
| Name                                                                                     | Description
| <<catalog-graph-create, gds.graph.create>>                                                | Creates a graph in the catalog using a <<catalog-graph-create, Native projection>>.
