...
Related functions for computing Jaccard similarity and the Overlap coefficient are described in <<alpha-algorithms-similarity-jaccard>> and <<alpha-algorithms-similarity-overlap>> respectively.
