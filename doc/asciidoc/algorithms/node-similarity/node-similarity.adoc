...
** <<algorithms-node-similarity-syntax-stream, Stream>>
** <<algorithms-node-similarity-syntax-stats, Stats>>
** <<algorithms-node-similarity-syntax-mutate, Mutate>>
** <<algorithms-node-similarity-syntax-write, Write>>
** <<algorithms-node-similarity-syntax-anonymous, Anonymous graphs>>
* <<algorithms-node-similarity-examples, Examples>>
** <<algorithms-node-similarity-examples-memory-estimation, Memory Estimation>>
** <<algorithms-node-similarity-examples-stream, Stream>>
** <<algorithms-node-similarity-examples-stats, Stats>>
** <<algorithms-node-similarity-examples-mutate, Mutate>>
** <<algorithms-node-similarity-examples-write, Write>>
** <<algorithms-node-similarity-examples-limits, Limit results>>
...
** <<algorithms-node-similarity-examples-weighted, Relationship weights>>
...
[[algorithms-node-similarity-syntax-stats]]
=== Stats
...
[[algorithms-node-similarity-syntax-mutate]]
=== Mutate
...
[[algorithms-node-similarity-syntax-write]]
=== Write
...
The results are the same as for running write mode with a named graph, <<algorithms-node-similarity-syntax-write, specified above>>.
...
CREATE (alice)-[:LIKES {strength: 0.5}]->(bongos)
...
:stats-syntax: algorithms-node-similarity-syntax-stats
...
[NOTE]
====
Weighted jaccard similarity is only defined for values greater than 0.
====
