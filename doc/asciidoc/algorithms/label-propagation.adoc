...
YIELD nodePropertiesWritten, ranIterations, didConverge, createMillis, computeMillis, writeMillis
----
...
| writeProperty              | String  | n/a     | no       | The node property to which the community ID is written to.
|===
...
YIELD ranIterations, didConverge, createMillis, computeMillis
----
