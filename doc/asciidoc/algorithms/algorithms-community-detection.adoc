...
** <<alpha-algorithms-conductance, Conductance metric>>
** <<alpha-algorithms-k-means, K-Means Clustering>>
...
include::alpha/conductance/conductance.adoc[leveloffset=+1]

include::alpha/kmeans/kmeans.adoc[leveloffset=+1]

include::alpha/leiden/leiden.adoc[leveloffset=+1]
