...
Similarly, `nodeSelfInfluence` behaves like an iteration weight for a stem:[0]:th iteration, or the amount of influence the projection of a node has on the embedding of the same node.
