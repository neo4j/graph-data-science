...
Lets say these are stem:[p1=[0.0, 2.4]], stem:[p2=[-2.4, 0.0]] and stem:[p3=[2.4, 0.0]].
Consider now a node `(n {f1: 0.5, f2: [1.0, -1.0])`.
The linear combination mentioned above, is in concrete terms stem:[0.5 * p1 + 1.0 * p2 - 1.0 * p3 = [-4.8, 1.2]] ].
