...
[source, cypher]
----
CALL gds.alpha.randomProjection.stream.estimate('persons', {embeddingSize: 128})
...
[source, cypher]
----
CALL gds.alpha.randomProjection.stats(
  'persons',
  {
    iterationWeights: [0.0, 0.34, 2.1],
    embeddingSize: 3,
...
[source, cypher]
----
CALL gds.alpha.randomProjection.mutate(
  'persons',
  {
    iterationWeights: [0.0, 0.34, 2.1],
    embeddingSize: 3,
