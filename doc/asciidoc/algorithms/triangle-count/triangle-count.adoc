...
** <<algorithms-triangle-count-syntax-triangles-listing, Triangles Listing>>
...
** <<algorithms-triangle-count-examples-triangles-listing, Triangles Listing>>
...
[role=query-example]
--
.The following will return a stream of node IDs, with the name property for each node in each triangle:
[source, cypher]
----
...
We can see that there are three triangles containing the nodes "Will, Michael, and Chris", "Will, Mark, and Michael", and "Michael, Karin, and Chris".
