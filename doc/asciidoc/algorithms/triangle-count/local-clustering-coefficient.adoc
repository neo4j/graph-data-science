...
include::lcc-specific-configuration.adoc[]
...
[source, cypher]
----
CALL gds.triangleCount.localClusteringCoefficient.write.estimate('myGraph', {
...
[source, cypher]
----
CALL gds.triangleCount.localClusteringCoefficient.stream('myGraph')
...
[source, cypher]
----
CALL gds.triangleCount.localClusteringCoefficient.stats('myGraph')
...
[source, cypher]
----
CALL gds.triangleCount.localClusteringCoefficient.mutate('myGraph', {
...
[source, cypher]
----
CALL gds.triangleCount.localClusteringCoefficient.write('myGraph', {
  writeProperty: 'localClusteringCoefficient'
})
YIELD averageClusteringCoefficient, nodeCount
----
