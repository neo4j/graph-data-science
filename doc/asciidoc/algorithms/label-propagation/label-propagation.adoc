...
** <<algorithms-label-propagation-syntax-stream, Stream>>
** <<algorithms-label-propagation-syntax-stats, Stats>>
** <<algorithms-label-propagation-syntax-mutate, Mutate>>
** <<algorithms-label-propagation-syntax-write, Write>>
** <<algorithms-label-propagation-syntax-anonymous, Anonymous graphs>>
* <<algorithms-label-propagation-examples, Examples>>
** <<algorithms-label-propagation-examples-memory-estimation, Memory Estimation>>
** <<algorithms-label-propagation-examples-stream, Stream>>
** <<algorithms-label-propagation-examples-stats, Stats>>
** <<algorithms-label-propagation-examples-write, Mutate>>
** <<algorithms-label-propagation-examples-write, Write>>
** <<algorithms-label-propagation-examples-weighted, Weighted>>
** <<algorithms-label-propagation-examples-seeding, Seeded communities>>
...
[[algorithms-label-propagation-syntax-stream]]
=== Stream
...
[[algorithms-label-propagation-syntax-stats]]
=== Stats
...
[[algorithms-label-propagation-syntax-mutate]]
=== Mutate
...
[[algorithms-label-propagation-syntax-write]]
=== Write
...
The results are the same as for running write mode with a named graph, <<algorithms-label-propagation-syntax-write, specified above>>.


[[algorithms-label-propagation-examples]]
== Examples

In this section we will show examples of executing the Label Propagation algorithm on a concrete graph.
...
image::label-propagation-graph.svg[align="center"]
...
:stats-syntax: algorithms-label-propagation-syntax-stats
