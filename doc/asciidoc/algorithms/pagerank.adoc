...
The above query returned a so called centrality histogram which can be used to monitor the distribution of page ranke values across all computed nodes.
This can be useful for debugging and normalization purposes.
