...
This can be verified in the <<algorithms-wcc-examples, example graph>>.
...
The result shows that `myGraph` has two components and this can be verified by looking at the <<algorithms-wcc-examples, example graph>>.
