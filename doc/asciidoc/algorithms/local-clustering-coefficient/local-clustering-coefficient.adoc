...
In the following examples we will demonstrate using the Local Clustering algorithm on this graph.
...
// TODO: analysis of the results, we would need the triangle counts for this;
// should we point to the triangle count page?
