...
** <<algorithms-louvain-examples-stream, Stream>>
** <<algorithms-louvain-examples-stats, Stats>>
** <<algorithms-louvain-examples-mutate, Mutate>>
** <<algorithms-louvain-examples-write, Write>>
** <<algorithms-louvain-examples-stream-weighted, Weighted>>
** <<algorithms-louvain-examples-stream-seeded, Seeded>>
** <<algorithms-louvain-examples-stream-intermediate, Stream intermediate communities>>
...
The results are the same as for running write mode with a named graph, see the <<algorithms-louvain-syntax, write mode syntax above>>.
...
| 6         | 14                | 5321     | 580104   | "[5321 Bytes \... 566 KiB]"
|===
--
