...
The algorithm calculates the shortest path between all pairs of nodes in an unweighted graph.
...
| centrality    | Float   | The denormalized Betweenness Centrality score.
|===
...
| minCentrality | Float     | The lowest centrality score.
| maxCentrality | Float     | The highest centrality score.
| sumCentrality | Float     | The sum of all centrality scores.
