...
When a property is a list of integers, we select Jaccard similarity:

image::equations/jaccard.png[size of intersection divided by size of union,align="center"]

This naturally gives us a score in the range `0..1`
