...
image::jaccard.png[size of intersection divided by size of union,align="center"]

The Overlap coefficient is defined as follows:

image::overlap.png[size of intersection divided by size of minimum set,align="center"]
