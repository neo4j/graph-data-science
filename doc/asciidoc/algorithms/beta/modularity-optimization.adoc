...
YIELD nodes, ranIterations, didConverge, modularity, createMillis, computeMillis, mutateMillis
----
...
| mutateProperty                 | String  | n/a         | yes      | The property name written back the ID of the partition particular node belongs to.
