...
NOTE: The names specified in the `nodePropertyNames` configuration parameter must exist in the in-memory graph.
...
Higher relationship weight between nodes signifies that the nodes should have more similar embedding values.
