...
.Loading the graph into the catalog:
[source, cypher]
----
...
In this example we returned the number of processed nodes, the number of colors used to color the graph, the number of iterations and information whether the algorithm converged.