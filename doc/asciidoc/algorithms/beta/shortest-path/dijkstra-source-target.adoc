...
The results are the same as for running write mode with a named graph, see the <<algorithms-dijkstra-source-target-syntax, write mode syntax above>>.
...
| 0     | "A"            | "F"            | 160.0     | [0, 1, 3, 4, 5] | [0.0, 50.0, 90.0, 120.0, 160.0]
|===
--
