...
* <<algorithms-dijkstra-source-target-intro, Introduction>>
* <<algorithms-dijkstra-source-target-syntax, Syntax>>
* <<algorithms-dijkstra-source-target-examples, Examples>>
** <<algorithms-dijkstra-source-target-examples-memory-estimation, Memory Estimation>>
...
To compute all paths from a source node to all reachable nodes, <<algorithms-dijkstra-single-source, Dijkstra Single-Source>> can be used.
