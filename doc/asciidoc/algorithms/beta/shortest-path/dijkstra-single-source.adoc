...
* <<algorithms-dijkstra-single-source-intro, Introduction>>
* <<algorithms-dijkstra-single-source-syntax, Syntax>>
* <<algorithms-dijkstra-single-source-examples, Examples>>
** <<algorithms-dijkstra-single-source-examples-memory-estimation, Memory Estimation>>
...
CALL gds.beta.allShortestPaths.dijkstra.write.estimate('myGraph', {
