...
The https://github.com/neo4j/graph-data-science/tree/1.8/examples/pregel-example[pregel-examples] module contains a set of examples for Pregel algorithms.
