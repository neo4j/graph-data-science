...
For an example on how to expose a custom Pregel computation via a Neo4j procedure, have a look at the https://github.com/neo-technology/graph-analytics/tree/1.3/public/examples/PregelK1Coloring/src/main/java/gds/example[K1-Coloring example].
