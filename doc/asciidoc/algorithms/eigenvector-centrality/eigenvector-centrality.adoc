...
|===
| Name          | Type   | Default | Optional | Description
include::../common-configuration/common-write-configuration-entries.adoc[]
include::specific-configuration.adoc[]
|===
...
Below, one can find an example for <<algorithms-eigenvector-centrality-examples-weighted, weighted graphs>>.
