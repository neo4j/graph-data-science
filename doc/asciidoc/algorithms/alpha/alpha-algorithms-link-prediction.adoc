...
include::alpha-linkprediction-adamic-adar.adoc[leveloffset=+1]

include::alpha-linkprediction-common-neighbors.adoc[leveloffset=+1]

include::alpha-linkprediction-preferential-attachment.adoc[leveloffset=+1]

include::alpha-linkprediction-resource-allocation.adoc[leveloffset=+1]

include::alpha-linkprediction-same-community.adoc[leveloffset=+1]

include::alpha-linkprediction-total-neighbors.adoc[leveloffset=+1]
