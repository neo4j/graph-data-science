...
CALL gds.alpha.ml.linkPrediction.train('myGraph', {
  ...
  randomSeed: 2,
  params: [
    {penalty: 0.5, maxEpochs: 1000, tolerance: 1e-5},
    {penalty: 1.0, maxEpochs: 1000, tolerance: 1e-5},
    {penalty: 0.0, maxEpochs: 1000, tolerance: 1e-5}
  ]
}) YIELD modelInfo
RETURN
...
| {maxEpochs=1000, penalty=0.5, tolerance=1.0E-5} | 0.38525757517173825 | 0.46710171439292664
|===
--
