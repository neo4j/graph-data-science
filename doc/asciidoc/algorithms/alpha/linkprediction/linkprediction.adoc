...
Tuning the `negativeClassWeight`, which is elaborated below, means weighting up or down the false positives when computing precision.
...
However, the higher the value, the slower evaluation becomes.
