...
The Greedy algorithm successively selecting the node within the maximum marginal gain approximation in PTIME. For large networks <<algorithms-celf, CELF>> algorithm should be used.
