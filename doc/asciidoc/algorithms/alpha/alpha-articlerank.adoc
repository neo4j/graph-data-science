...
|===
| Name      | ArticleRank
| "Paper 0" | 0.34627691782989134
| "Paper 1" | 0.31950149169715586
...
CALL gds.alpha.articleRank.write({
  ...
  nodes, maxIterations, createMillis, computeMillis, writeMillis, dampingFactor, writeProperty
----
...
YIELD nodes, maxIterations, createMillis, computeMillis, writeMillis, dampingFactor, writeProperty
----
