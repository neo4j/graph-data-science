[[algorithms-betweenness-centrality-alpha]]
[.alpha]
= Betweenness Centrality (Alpha)
...
* <<algorithms-betweenness-centrality-alpha-context, History and explanation>>
* <<algorithms-betweenness-centrality-alpha-usecase, Use-cases - when to use the Betweenness Centrality algorithm>>
* <<algorithms-betweenness-centrality-alpha-limitations, Constraints - when not to use the Betweenness Centrality algorithm>>
* <<algorithms-betweenness-centrality-alpha-syntax, Syntax>>
* <<algorithms-betweenness-centrality-alpha-sample, Betweenness Centrality example>>
* <<algorithms-betweenness-centrality-alpha-approx, Sampled Betweenness Centrality>>
** <<algorithms-betweenness-centrality-alpha-ra_brandes, Sampled Betweenness Centrality example>>
* <<algorithms-betweenness-centrality-alpha-cp, Cypher projection>>


[[algorithms-betweenness-centrality-alpha-context]]
...
[[algorithms-betweenness-centrality-alpha-usecase]]
...
[[algorithms-betweenness-centrality-alpha-limitations]]
...
[[algorithms-betweenness-centrality-alpha-syntax]]
== Syntax
...
[[algorithms-betweenness-centrality-alpha-sample]]
...
[[algorithms-betweenness-centrality-alpha-approx]]
...
[[algorithms-betweenness-centrality-alpha-ra_brandes]]
...
[[algorithms-betweenness-centrality-alpha-cp]]
== Cypher projection
