...
The classification model can be used to predict the class of previously unseen nodes.
...
The latter is also a model which is stored in the catalog with type `Node classification model`.
