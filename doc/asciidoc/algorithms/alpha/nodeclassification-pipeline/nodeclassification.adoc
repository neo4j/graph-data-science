...
// TODO fix this docs
The `gds.beta.pipeline.nodeClassification.addLogisticRegression` procedure is used to set up the train mode with a configurations of logistic regression models.
