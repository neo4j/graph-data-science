...
| 66690312  | 66722272  | +"[63 MiB ... 63 MiB]"+
|===
--
...
| {useBiasFeature=true, maxEpochs=100, minEpochs=1, penalty=0.0625, patience=1, methodName=LogisticRegression, batchSize=100, tolerance=0.001} | 0.999999989939394 | 0.9999999912121211 | 0.9999999850000002
|===
