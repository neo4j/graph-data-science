...
CALL gds.graph.create(
  'myGraph',
  { House: { properties: ['sizePerStory', 'class'] }, UnknownHouse: { properties: 'sizePerStory' } },
  '*'
)
...
In order to analyse our predicted classes we will write them back to Neo4j:
...
| "Pink"	        | "predicted_probability" | [0.9999769150777453, 0.000022996000641421068, 8.892161327418462e-8]
| "Pink"	        | "predicted_class"	      | 0
| "Tan"	            | "predicted_probability" |	[0.000871766942288527, 0.9991282329206609, 1.3705053892090503e-10]
| "Tan"	            | "predicted_class"	      | 1
| "Yellow"	        | "predicted_probability" | [0.0023432260604598415, 0.0642890431313016, 0.9333677308082385]
