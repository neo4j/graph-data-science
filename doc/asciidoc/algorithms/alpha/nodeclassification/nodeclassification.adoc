...
| bestParameters | Map           | The map in `params` which contains the model configuration which performed best on average on validation folds according to the primary metric.
