...
= HITS
:entity: node
:result: authorirty and hub scores
:algorithm: HITS
...
* <<algorithms-hits-intro, Introduction>>
* <<algorithms-hits-syntax, Syntax>>
* <<algorithms-hits-examples, Examples>>
** <<algorithms-hits-examples-stream, Stream>>
