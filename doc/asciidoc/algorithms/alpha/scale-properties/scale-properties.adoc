...
See <<algorithms-scale-properties-examples-list, the list example>> for more details.
...
Note we can only specify the one scaler per array property.
...
|===
| name       | features
| "Beach"    | [-0.17956547594003253, 0.18388925876213183, 0.18437421939709808, 0.0]
| "Central"  | [2.172199255871029, 0.0766205244842216, 0.07682259141545754, 0.07473073005828626]
| "East"     | [-0.0447509371737933, 0.024518567834950912, 0.024583229252946412, 0.0]
| "Forest"   | [-0.8536381697712284, 0.04214128846632188, 0.015364518283091507, 0.0]
| "Mountain" | [0.32973389273242665, 0.061296419587377284, 0.0, 0.0]
| "Plaza"    | [0.5394453974799097, 0.013791694407159888, 0.015364518283091507, 0.0]
| "Polar"    | [-0.672387512096618, 0.95775655605277, 0.9602823926932192, 0.9608236721779662]
| "West"     | [-1.2910364511016934, 0.191551311210554, 0.19205647853864385, 0.2668954644938795]
|===
--
...
The other three list positions are the L2-norm scaled values for the `storyCapacity` list property.
