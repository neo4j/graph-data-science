...
image::equations/scale-properties/minmax.svg[minmax of p equals p minus minimum of p divided by maximum of p minus minimum of p,align="center"]
...
image::equations/scale-properties/mean.svg[mean of p equals p minus average of p divided by maximum of p minus minimum of p,align="center"]

=== Log scaler

Transforms all property values using the natural logarithm.

image::equations/scale-properties/log.svg[p equals natural logarithm of p,align="center"]
...
image::equations/scale-properties/standardScore.svg[p equals  p minus average of p divided by standard deviation of p,align="center"]


=== L2 Norm

Scaling the components of a feature vector such that the complete vector has length one by dividing with the L2 norm of the vector:

image::equations/scale-properties/l2norm.svg[p equals p divided by l2 norm of p ,align="center"]
