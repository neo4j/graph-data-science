...
|===
| parameterSpace
| {RandomForest=[], LogisticRegression=[{useBiasFeature=true, maxEpochs=500, minEpochs=1, penalty=0.0, patience=1, methodName=LogisticRegression, batchSize=100, tolerance=0.001}]}
|===
