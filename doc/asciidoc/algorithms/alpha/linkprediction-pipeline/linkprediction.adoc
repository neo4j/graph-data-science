...
[source, cypher, role=noplay]
----
CALL gds.alpha.ml.pipeline.linkPrediction.configureSplit('pipe', {testFraction: 0.3, validationFolds: 7})
YIELD splitConfig
----
...
|===
| splitConfig
| {negativeSamplingRatio=1.0, testFraction=0.3, validationFolds=7, trainFraction=0.1}
|===
--
