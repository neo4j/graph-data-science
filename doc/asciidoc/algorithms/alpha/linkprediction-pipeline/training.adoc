...
[[algorithms-ml-linkprediction-pipeline-examples-train-estimate]]
==== Memory Estimation
...
| {useBiasFeature=true, maxEpochs=500, minEpochs=1, penalty=0.0, patience=1, methodName=LogisticRegression, batchSize=100, tolerance=0.001} | 0.3721560846560847 |  0.3801587301587301 | 0.7638888888888888
|===
