...
| {useBiasFeature=true, maxEpochs=100, minEpochs=1, penalty=0.0, patience=1, batchSize=100, tolerance=0.001} | 0.4523809523809523 |  0.41666666666666663 | 0.7638888888888888
|===
