...
:modelType: Link prediction model
:entity: relationship
...
After <<algorithms-ml-linkprediction-pipelines-train, training>>, the runnable model is of type `Link prediction model` and resides in the <<model-catalog-ops,model catalog>>.
...
| "Alice"   | "Chris"   | 0.7548379139232353
| "Chris"   | "Mark"    | 0.7210215195730523
| "Alice"   | "Mark"    | 0.5699897489462986
| "Alice"   | "Karin"   | 0.5654959871679817
| "Alice"   | "Greg"    | 0.5635853857187089
|===
