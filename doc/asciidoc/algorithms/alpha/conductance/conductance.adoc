...
[NOTE]
====
Only non-negative community IDs are valid, and negative one are ignored in the computation.
====
...
| 3              | 0.29338842975206614 | [0.29338842975206614]
|1 row
|===
--
...
The distribution of nodes into communities is the following:
