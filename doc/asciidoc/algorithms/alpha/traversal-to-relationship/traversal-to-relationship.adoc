...
* <<algorithms-traversal-to-relationship-intro, Introduction>>
* <<algorithms-traversal-to-relationship-syntax, Syntax>>
* <<algorithms-traversal-to-relationship-examples, Examples>>

[[algorithms-traversal-to-relationship-intro]]
== Introduction

The Traversal to Relationship algorithm is a traversal algorithm capable of creating relationships between the start and end nodes of the traversal.
