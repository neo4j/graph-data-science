...
To make predictions also utilizing node properties one can use the machine learning based methods <<algorithms-ml-linkprediction, Link prediction>> and <<algorithms-ml-linkprediction-pipelines, Link prediction pipelines>>.
====
