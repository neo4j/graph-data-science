[[labs-algorithms-linkprediction-total-neighbors]]
= The Total Neighbors algorithm

[abstract]
--
This section describes the Total Neighbors algorithm in the Neo4j Labs Graph Algorithms library.
--
...
[WARNING]
--
The Total Neighbors algorithm is part of Neo4j Labs and not supported for production purposes.
--
