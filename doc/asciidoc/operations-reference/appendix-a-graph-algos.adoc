...
| Cosine Similarity | `_gds.alpha.similarity.cosine_`
.2+<.^|Euclidean Similarity
| `_gds.alpha.similarity.euclidean_`
| `_gds.alpha.similarity.euclideanDistance_`
| Jaccard Similarity | `_gds.alpha.similarity.jaccard_`
| Overlap Similarity | `_gds.alpha.similarity.overlap_`
| Pearson Similarity | `_gds.alpha.similarity.pearson_`
...
.12+<.^| <<algorithms-ml-linkprediction-pipelines, Link Prediction Pipeline>>
...
.14+<.^| <<algorithms-ml-nodeclassification-pipelines, Node Classification Pipeline>>
