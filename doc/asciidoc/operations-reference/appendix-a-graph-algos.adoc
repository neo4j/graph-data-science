...
.6+<.^|<<similarity-functions, Similarity functions>>
...
.12+<.^| <<linkprediction-pipelines, Link Prediction Pipeline>>
...
.14+<.^| <<nodeclassification-pipelines, Node Classification Pipeline>>
...
.2+<.^|<<algorithms-harmonic-centrality, Harmonic Centrality>>
...
.1+<.^| <<linkprediction-pipelines, Link Prediction Pipeline>>
| `gds.alpha.pipeline.linkPrediction.addRandomForest`
.1+<.^| <<nodeclassification-pipelines, Node Classification Pipeline>>
...
.1+<.^| <<alpha-algorithms-conductance, Conductance>>
