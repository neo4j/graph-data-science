...
| Cosine Similarity | `_gds.similarity.cosine_`
.2+<.^|Euclidean Similarity
| `_gds.similarity.euclidean_`
| `_gds.similarity.euclideanDistance_`
| Jaccard Similarity | `_gds.similarity.jaccard_`
| Overlap Similarity | `_gds.similarity.overlap_`
| Pearson Similarity | `_gds.similarity.pearson_`
...
|===
|Algorithm name | Operation
.3+<.^|<<algorithms-closeness-centrality, Closeness Centrality>>
