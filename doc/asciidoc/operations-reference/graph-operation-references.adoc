...
.4+<.^|<<catalog-graph-create, Project Graph>>
| `gds.graph.project`
| `gds.graph.project.estimate`
| `gds.graph.project.cypher`
| `gds.graph.project.cypher.estimate`
.4+<.^|<<catalog-graph-create, Deprecated: Create Graph>>
| `gds.graph.create`
...
|===
|Description                                | Operation
|<<catalog-graph-create-subgraph, Project a graph from a named graph>> | `gds.beta.graph.project.subgraph`
|<<catalog-graph-create-subgraph, Deprecated: Create a graph from a named graph>> | `gds.beta.graph.create.subgraph`
