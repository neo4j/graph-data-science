...
.List of all production-quality machine learning algorithms in the GDS library. Functions are written in _italic_.
[[table-product]]
...
.List of all beta machine learning algorithms in the GDS library. Functions are written in _italic_.
[[table-beta]]
[role=procedure-listing]
[opts=header,cols="1, 2"]
|===
...
.List of all alpha machine learning algorithms in the GDS library. Functions are written in _italic_.
[[table-alpha]]
[role=procedure-listing]
[opts=header,cols="1, 2"]
|===
