...
[[experimental-algorithms-similarity-euclidean]]
...
[WARNING]
--
The Euclidean Distance algorithm is experimental and not officially supported.
--
...
include::experimental-similarity.adoc[tag=weighted-function-note]
...
include::experimental-similarity.adoc[tag=computation]
include::experimental-similarity.adoc[tag=weighted-note]
...
include::experimental-similarity.adoc[tag=source-target-ids]
