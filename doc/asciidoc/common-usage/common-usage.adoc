...
* as much memory as it needs (see <<memory-estimation, Memory estimation>>)
...
To get an overview of the status of the system you can use the <<monitoring-system, System monitor procedure>>.
====
...
include::projecting-graphs.adoc[leveloffset=+1]

include::running-algorihms.adoc[leveloffset=+1]

include::logging.adoc[leveroffset=+1]

include::debug-sysinfo.adoc[leveroffset=+1]
