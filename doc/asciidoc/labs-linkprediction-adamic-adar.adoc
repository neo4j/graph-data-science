...
[abstract]
--
This section describes the Adamic Adar algorithm in the Neo4j Labs Graph Algorithms library.
--
...
[WARNING]
--
The Adamic Adar algorithm is part of Neo4j Labs and not supported for production purposes.
--
