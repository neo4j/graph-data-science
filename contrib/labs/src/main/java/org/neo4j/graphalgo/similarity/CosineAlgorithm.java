...
public class CosineAlgorithm extends WeightedAlgorithm {
    public CosineAlgorithm(GraphDatabaseAPI api, ProcedureConfiguration configuration) {
    ...
    public SimilarityComputer<WeightedInput> similarityComputer(final Double skipValue) {
        return skipValue == null ?
                (decoder, s, t, cutoff) -> s.cosineSquares(decoder, cutoff, t, false) :
                (decoder, s, t, cutoff) -> s.cosineSquaresSkip(decoder, cutoff, t, skipValue, false);
    }
