...
public interface CustomAccessMode {
    ...
    default boolean allowsTraverseRelType(int relType) {
        return true;
    }

    default boolean allowsReadNodeProperty(int propertyKey) {
        return true;
    }

    default boolean allowsReadRelationshipProperty(int propertyKey) {
        return true;
    }
}
