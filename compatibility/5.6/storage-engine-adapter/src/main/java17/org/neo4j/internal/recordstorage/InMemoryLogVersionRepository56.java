...
public class InMemoryLogVersionRepository56 implements LogVersionRepository {
    ...
    private InMemoryLogVersionRepository56(long initialLogVersion, long initialCheckpointLogVersion) {
