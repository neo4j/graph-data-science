...
final class MemoryTrackerProxyAura implements MemoryTrackerProxy {
    ...
    static MemoryTrackerProxy of(MemoryTracker memoryTracker) {
        ...
        return new MemoryTrackerProxyAura(new AllocationTrackerAdapterAura(memoryTracker));
    }

    private MemoryTrackerProxyAura(AllocationTrackerAdapter allocationTracker) {
