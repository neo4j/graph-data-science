...
public class InMemoryLogVersionRepository519 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository519() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository519(long initialLogVersion, long initialCheckpointLogVersion) {
