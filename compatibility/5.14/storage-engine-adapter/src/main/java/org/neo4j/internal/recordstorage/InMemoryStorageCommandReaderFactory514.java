...
public class InMemoryStorageCommandReaderFactory514 implements CommandReaderFactory {

    public static final CommandReaderFactory INSTANCE = new InMemoryStorageCommandReaderFactory514();
