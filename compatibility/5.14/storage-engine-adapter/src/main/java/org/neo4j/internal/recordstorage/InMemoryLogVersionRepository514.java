...
public class InMemoryLogVersionRepository514 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository514() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository514(long initialLogVersion, long initialCheckpointLogVersion) {
