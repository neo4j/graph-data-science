...
import org.neo4j.internal.recordstorage.InMemoryLogVersionRepository513;
...
public class InMemoryMetaDataProviderImpl implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository513 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProviderImpl() {
        this.logVersionRepository = new InMemoryLogVersionRepository513();
