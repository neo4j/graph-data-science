...
public class InMemoryLogVersionRepository513 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository513() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository513(long initialLogVersion, long initialCheckpointLogVersion) {
