...
import org.neo4j.internal.recordstorage.InMemoryStorageCommandReaderFactory58;
...
public class InMemoryStorageEngineFactory implements StorageEngineFactory {
    ...
    static final String IN_MEMORY_STORAGE_ENGINE_NAME = "in-memory-58";

    public InMemoryStorageEngineFactory() {
        StorageEngineProxyApi.requireNeo4jVersion(Neo4jVersion.V_5_8, StorageEngineFactory.class);
    }
    ...
    public CommandReaderFactory commandReaderFactory() {
        return InMemoryStorageCommandReaderFactory58.INSTANCE;
    }
