...
public class InMemoryLogVersionRepository59 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository59() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository59(long initialLogVersion, long initialCheckpointLogVersion) {
