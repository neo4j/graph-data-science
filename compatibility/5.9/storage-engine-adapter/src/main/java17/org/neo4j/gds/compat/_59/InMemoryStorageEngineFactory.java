...
import org.neo4j.internal.recordstorage.InMemoryStorageCommandReaderFactory59;
...
public class InMemoryStorageEngineFactory implements StorageEngineFactory {
    ...
    static final String IN_MEMORY_STORAGE_ENGINE_NAME = "in-memory-59";

    public InMemoryStorageEngineFactory() {
        StorageEngineProxyApi.requireNeo4jVersion(Neo4jVersion.V_5_9, StorageEngineFactory.class);
    }
    ...
    public CommandReaderFactory commandReaderFactory() {
        return InMemoryStorageCommandReaderFactory59.INSTANCE;
    }
