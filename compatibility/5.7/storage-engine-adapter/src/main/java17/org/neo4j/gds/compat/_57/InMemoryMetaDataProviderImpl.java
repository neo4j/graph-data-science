...
import org.neo4j.internal.recordstorage.InMemoryLogVersionRepository57;
...
public class InMemoryMetaDataProviderImpl implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository57 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProviderImpl() {
        this.logVersionRepository = new InMemoryLogVersionRepository57();
