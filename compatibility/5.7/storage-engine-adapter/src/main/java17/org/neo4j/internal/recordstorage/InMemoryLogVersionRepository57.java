...
public class InMemoryLogVersionRepository57 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository57() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository57(long initialLogVersion, long initialCheckpointLogVersion) {
