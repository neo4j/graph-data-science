...
public class InMemoryLogVersionRepository518 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository518() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository518(long initialLogVersion, long initialCheckpointLogVersion) {
