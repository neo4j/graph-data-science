...
public class InMemoryLogVersionRepository517 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository517() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository517(long initialLogVersion, long initialCheckpointLogVersion) {
