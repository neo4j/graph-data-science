...
import org.neo4j.internal.recordstorage.InMemoryLogVersionRepository517;
...
public class InMemoryMetaDataProviderImpl implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository517 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProviderImpl() {
        this.logVersionRepository = new InMemoryLogVersionRepository517();
