...
public class InMemoryLogVersionRepository52 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository52() {
        this(0,0);
    }

    private InMemoryLogVersionRepository52(long initialLogVersion, long initialCheckpointLogVersion) {
