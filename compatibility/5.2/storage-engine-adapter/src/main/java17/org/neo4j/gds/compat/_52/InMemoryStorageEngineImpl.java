...
import org.neo4j.internal.recordstorage.InMemoryStorageReader52;
...
public final class InMemoryStorageEngineImpl implements StorageEngine {
    ...
    InMemoryStorageEngineImpl(
        ...
        this.counts = new InMemoryCountsStoreImpl(graphStore, tokenHolders);
    ...
    public StorageReader newReader() {
        return new InMemoryStorageReader52(graphStore, tokenManager.tokenHolders(), counts);
    }
