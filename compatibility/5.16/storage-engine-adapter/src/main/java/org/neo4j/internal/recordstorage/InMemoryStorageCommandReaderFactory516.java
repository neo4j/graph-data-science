...
public class InMemoryStorageCommandReaderFactory516 implements CommandReaderFactory {

    public static final CommandReaderFactory INSTANCE = new InMemoryStorageCommandReaderFactory516();
