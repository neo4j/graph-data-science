...
public class InMemoryLogVersionRepository516 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository516() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository516(long initialLogVersion, long initialCheckpointLogVersion) {
