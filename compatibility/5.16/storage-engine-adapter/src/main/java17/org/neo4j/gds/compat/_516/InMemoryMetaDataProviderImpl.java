...
import org.neo4j.internal.recordstorage.InMemoryLogVersionRepository516;
...
public class InMemoryMetaDataProviderImpl implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository516 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProviderImpl() {
        this.logVersionRepository = new InMemoryLogVersionRepository516();
