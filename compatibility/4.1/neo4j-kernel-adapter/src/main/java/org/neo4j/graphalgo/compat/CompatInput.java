...
public interface CompatInput
{
     ...
     */
    Input.Estimates calculateEstimates(PropertySizeCalculatorCompat propertySizeCalculator) throws IOException;

    default Input toInput() {
        return KernelApiProxy.batchInputFrom(this);
    }
}
