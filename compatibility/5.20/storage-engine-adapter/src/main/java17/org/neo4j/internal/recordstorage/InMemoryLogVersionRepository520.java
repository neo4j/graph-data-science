...
public class InMemoryLogVersionRepository520 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository520() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository520(long initialLogVersion, long initialCheckpointLogVersion) {
