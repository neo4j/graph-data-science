...
import org.neo4j.internal.recordstorage.InMemoryStorageCommandReaderFactory520;
...
public class InMemoryStorageEngineFactory implements StorageEngineFactory {
    ...
    static final String IN_MEMORY_STORAGE_ENGINE_NAME = "in-memory-520";

    public InMemoryStorageEngineFactory() {
        StorageEngineProxyApi.requireNeo4jVersion(Neo4jVersion.V_5_20, StorageEngineFactory.class);
    }
    ...
    private TokenHolders loadReadOnlyTokens(
        ...
        try (
            ...
            TokenHolder propertyKeys = new CreatingTokenHolder( ReadOnlyTokenCreator.READ_ONLY, TokenHolder.TYPE_PROPERTY_KEY );
            TokenHolder labels = new CreatingTokenHolder( ReadOnlyTokenCreator.READ_ONLY, TokenHolder.TYPE_LABEL );
            TokenHolder relationshipTypes = new CreatingTokenHolder( ReadOnlyTokenCreator.READ_ONLY, TokenHolder.TYPE_RELATIONSHIP_TYPE );
    ...
    public CommandReaderFactory commandReaderFactory() {
        return InMemoryStorageCommandReaderFactory520.INSTANCE;
    }
    @Override
    ...
    public IncrementalBatchImporter incrementalBatchImporter(
        ...
        boolean b,
        AdditionalInitialIds additionalInitialIds,
        ThrowingSupplier<LogTailMetadata, IOException> throwingSupplier,
        Config config,
        Monitor monitor,
        JobScheduler jobScheduler,
        Collector collector,
    ...
    @Override
    public StoreFormatLimits limitsForFormat(String formatName, boolean includeFormatsUnderDevelopment) throws
