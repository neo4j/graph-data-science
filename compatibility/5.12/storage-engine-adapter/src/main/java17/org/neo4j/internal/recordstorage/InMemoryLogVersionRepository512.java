...
public class InMemoryLogVersionRepository512 implements LogVersionRepository {

    private final AtomicLong logVersion;
    private final AtomicLong checkpointLogVersion;

    public InMemoryLogVersionRepository512() {
        this(0, 0);
    }

    private InMemoryLogVersionRepository512(long initialLogVersion, long initialCheckpointLogVersion) {
