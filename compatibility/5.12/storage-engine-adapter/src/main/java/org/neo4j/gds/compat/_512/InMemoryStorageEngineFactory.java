...
import org.neo4j.internal.recordstorage.InMemoryStorageCommandReaderFactory512;
...
public class InMemoryStorageEngineFactory implements StorageEngineFactory {
    ...
    static final String IN_MEMORY_STORAGE_ENGINE_NAME = "in-memory-512";

    public InMemoryStorageEngineFactory() {
        StorageEngineProxyApi.requireNeo4jVersion(Neo4jVersion.V_5_12, StorageEngineFactory.class);
    }
    ...
    public CommandReaderFactory commandReaderFactory() {
        return InMemoryStorageCommandReaderFactory512.INSTANCE;
    }
    @Override
