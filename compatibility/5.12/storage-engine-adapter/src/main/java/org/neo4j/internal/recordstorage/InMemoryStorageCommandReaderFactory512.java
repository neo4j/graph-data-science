...
public class InMemoryStorageCommandReaderFactory512 implements CommandReaderFactory {

    public static final CommandReaderFactory INSTANCE = new InMemoryStorageCommandReaderFactory512();
