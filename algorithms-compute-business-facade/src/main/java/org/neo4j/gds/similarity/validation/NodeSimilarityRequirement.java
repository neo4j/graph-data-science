...
public class NodeSimilarityRequirement implements AlgorithmGraphStoreRequirements {
    ...
    public NodeSimilarityRequirement(boolean useComponents,  String componentProperty) {
    ...
    public void validate(
        ...
        if (useComponents && componentProperty != null){
            new NodePropertyMustExistOnAllLabels(
                componentProperty
