...
/**
 * Given we have an asynchronous backend,
 * the first thing we need is a way to make the asynchronous calls synchronous again,
 * because plugin
 */
public class Synchroniser {
    private final CompletionConvenience completionConvenience;

    public Synchroniser(CompletionConvenience completionConvenience) {
        this.completionConvenience = completionConvenience;
    }

    public <RESULT> RESULT synchronise(Supplier<CompletableFuture<RESULT>> supplier) {
