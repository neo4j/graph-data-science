...
public class DoubleVectorImpl implements DoubleVector {

    private final double[] value;

    public DoubleVectorImpl(double[] value) {
        this.value = value;
    }

    @Override
    public double[] doubleVectorValue() {
    ...
    public String toString() {
        return "DoubleVector" + Arrays.toString(value);
    }
}
