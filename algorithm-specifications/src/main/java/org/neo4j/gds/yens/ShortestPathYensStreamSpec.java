...
@GdsCallable(name = "gds.shortestPath.yens.stream", description = Constants.YENS_DESCRIPTION, executionMode = STREAM)
public class ShortestPathYensStreamSpec implements AlgorithmSpec<Yens, PathFindingResult, ShortestPathYensStreamConfig, Stream<PathFindingStreamResult>, YensFactory<ShortestPathYensStreamConfig>> {
    ...
    @Override
    public YensFactory<ShortestPathYensStreamConfig> algorithmFactory(ExecutionContext executionContext) {
