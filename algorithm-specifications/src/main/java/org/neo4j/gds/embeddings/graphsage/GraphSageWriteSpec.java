...
public class GraphSageWriteSpec implements AlgorithmSpec<GraphSage, GraphSageResult, GraphSageWriteConfig, Stream<DefaultNodeEmbeddingsWriteResult>, GraphSageAlgorithmFactory<GraphSageWriteConfig>> {
    ...
    @Override
    public ComputationResultConsumer<GraphSage, GraphSageResult, GraphSageWriteConfig, Stream<DefaultNodeEmbeddingsWriteResult>> computationResultConsumer() {
