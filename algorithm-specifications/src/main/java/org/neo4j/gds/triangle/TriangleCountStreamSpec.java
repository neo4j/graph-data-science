...
@GdsCallable(name = "gds.triangleCount.stream", description = Constants.TRIANGLE_COUNT_DESCRIPTION, executionMode = STREAM)
public class TriangleCountStreamSpec implements AlgorithmSpec<IntersectingTriangleCount, TriangleCountResult, TriangleCountStreamConfig, Stream<TriangleCountStreamResult>, IntersectingTriangleCountFactory<TriangleCountStreamConfig>> {
    ...
    @Override
    public IntersectingTriangleCountFactory<TriangleCountStreamConfig> algorithmFactory(ExecutionContext executionContext) {
