...
@GdsCallable(name = "gds.localClusteringCoefficient.write", description = Constants.LOCAL_CLUSTERING_COEFFICIENT_DESCRIPTION, executionMode = WRITE_NODE_PROPERTY)
