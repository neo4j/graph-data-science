...
@GdsCallable(name = "gds.randomWalk.stats", description = Constants.RANDOM_WALK_DESCRIPTION, executionMode = STATS)
public class RandomWalkStatsSpec implements AlgorithmSpec<RandomWalk, Stream<long[]>, RandomWalkStatsConfig, Stream<StandardModeResult>, RandomWalkAlgorithmFactory<RandomWalkStatsConfig>> {
    ...
    @Override
    public RandomWalkAlgorithmFactory<RandomWalkStatsConfig> algorithmFactory(ExecutionContext executionContext) {
