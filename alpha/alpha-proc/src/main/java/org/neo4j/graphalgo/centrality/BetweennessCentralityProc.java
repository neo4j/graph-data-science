...
//import org.neo4j.graphalgo.betweenness.BetweennessCentralityStreamConfig;
...
//
//public class BetweennessCentralityProc extends AlgoBaseProc<BetweennessCentrality, BetweennessCentrality, BetweennessCentralityStreamConfig> {
//
...
//    ) {
//        ComputationResult<BetweennessCentrality, BetweennessCentrality, BetweennessCentralityStreamConfig> computationResult = compute(
//            graphNameOrConfig,
//            configuration
//        );
...
//        BetweennessCentralityStreamConfig config = computationResult.config();
//
//        if (graph.isEmpty()) {
...
//    ) {
//        return BetweennessCentralityStreamConfig.of(graphName, maybeImplicitCreate, username, config);
//    }
//
//    @Override
