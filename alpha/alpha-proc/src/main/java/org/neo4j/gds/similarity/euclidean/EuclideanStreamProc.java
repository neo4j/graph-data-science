...
@GdsCallable(name = "gds.alpha.similarity.euclidean.stream", description = DESCRIPTION, executionMode = STREAM)
public class EuclideanStreamProc extends EuclideanProc<SimilarityResult> {
    ...
    @Override
    public ComputationResultConsumer<EuclideanAlgorithm, SimilarityAlgorithmResult, EuclideanConfig, Stream<SimilarityResult>> computationResultConsumer() {
