...
public class GreedyProc extends AlgoBaseProc<Greedy, Greedy, InfluenceMaximizationConfig, InfluenceMaximizationResult> {
    ...
    @Override
    public AlgorithmSpec<Greedy, Greedy, InfluenceMaximizationConfig, Stream<InfluenceMaximizationResult>, AlgorithmFactory<?, Greedy, InfluenceMaximizationConfig>> withModelCatalog(
