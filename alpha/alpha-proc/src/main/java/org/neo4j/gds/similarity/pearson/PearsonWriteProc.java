...
public final class PearsonWriteProc extends PearsonProc<AlphaSimilaritySummaryResult> {
    ...
    @Override
    public ComputationResultConsumer<PearsonAlgorithm, SimilarityAlgorithmResult, PearsonConfig, Stream<AlphaSimilaritySummaryResult>> computationResultConsumer() {
