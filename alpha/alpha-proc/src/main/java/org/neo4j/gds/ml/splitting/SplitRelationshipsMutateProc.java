...
public class SplitRelationshipsMutateProc extends MutateProc<SplitRelationships, SplitResult, SplitRelationshipsMutateProc.MutateResult, SplitRelationshipsMutateConfig> {
    ...
    @Override
    public AlgorithmSpec<SplitRelationships, SplitResult, SplitRelationshipsMutateConfig, Stream<MutateResult>, AlgorithmFactory<?, SplitRelationships, SplitRelationshipsMutateConfig>> withModelCatalog(
