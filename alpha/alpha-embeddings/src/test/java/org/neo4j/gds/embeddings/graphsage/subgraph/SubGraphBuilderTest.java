...
class SubGraphBuilderTest {
    ...
    void shouldBuildSubGraphSingleNode() {
        SubGraph subGraph = subGraphBuilder.buildSubGraph(List.of(0L), neighborhoodFunction, graph);

        int[] expectedAdj = new int[] {1, 2, 3};
        List<Long> expectedNeighbors = List.of(
            idFunction.of("a"),
            idFunction.of("b"),
            idFunction.of("d"),
            idFunction.of("e")
        ...
        assertEquals(expectedNeighbors, subGraph.nextNodes);
    }

    @Test
    void shouldBuildSubGraphAnotherNode() {
        SubGraph subGraph = subGraphBuilder.buildSubGraph(List.of(1L), neighborhoodFunction, graph);
    ...
    void shouldBuildSubGraphMultipleNodes() {
        SubGraph subGraph = subGraphBuilder.buildSubGraph(List.of(0L, 1L, 2L), neighborhoodFunction, graph);
    ...
    void shouldBuildMultipleSubGraphs() {
        ...
        List<Long> expectedNeighbors = new LinkedList<>(List.of(
        ...
        assertEquals(expectedNeighbors, subGraphs.get(0).nextNodes);
        ...
        expectedNeighbors.addAll(List.of(idFunction.of("g"), idFunction.of("h"), idFunction.of("i")));
        ...
        assertEquals(expectedNeighbors, subGraphs.get(1).nextNodes);
    }
}
