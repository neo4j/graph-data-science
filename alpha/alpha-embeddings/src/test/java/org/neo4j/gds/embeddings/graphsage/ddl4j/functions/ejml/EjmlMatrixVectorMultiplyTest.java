...
class EjmlMatrixVectorMultiplyTest extends AutogradBaseTest {
    ...
    void shouldMultiplyCorrectly() {
        ...
        EjmlMatrixVectorMultiply multiply = new EjmlMatrixVectorMultiply(weights, vector);

        assertNotNull(ctx.forward(multiply));
        assertArrayEquals(
            new double[]{
                15,
                33
    ...
    void shouldThrowWhenDimensionsMismatch() {
        ...
        IllegalArgumentException exception = assertThrows(
            ...
            () -> new EjmlMatrixVectorMultiply(weights, vector)
        );
