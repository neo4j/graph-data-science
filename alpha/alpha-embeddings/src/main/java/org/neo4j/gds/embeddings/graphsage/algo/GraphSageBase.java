...
public abstract class GraphSageBase<ALGO extends GraphSageBase<ALGO, RESULT, CONFIG>, RESULT, CONFIG extends GraphSageBaseConfig>
    ...
    GraphSageBase(Graph graph, CONFIG config) {
