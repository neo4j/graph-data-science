 ...
 */
public class LegacyRABrandesBetweennessCentrality extends Algorithm<LegacyRABrandesBetweennessCentrality, LegacyRABrandesBetweennessCentrality> {
    ...
    private RABrandesBetweennessCentrality.SelectionStrategy selectionStrategy;

    private int maxDepth = Integer.MAX_VALUE;

    public LegacyRABrandesBetweennessCentrality(
        Graph graph,
        ExecutorService executorService,
        int concurrency,
        RABrandesBetweennessCentrality.SelectionStrategy selectionStrategy
    ) {
    ...
    public LegacyRABrandesBetweennessCentrality(
        ...
        this.expectedNodeCount = (int) selectionStrategy.size();
     ...
     */
    @Override
    public LegacyRABrandesBetweennessCentrality compute() {
        nodeQueue.set(0);
    ...
    @Override
    public LegacyRABrandesBetweennessCentrality me() {
        return this;
    }
