 ...
 */
@ValueClass
public interface BestMetricData<CONFIG extends TrainingConfig> {

    /**
     * Train metric
     * @return the metric stats on the train set
     */
    ModelStats<CONFIG> train();

    /**
     * Validation metric
     * @return the metric stats on the validation set
     */
    ModelStats<CONFIG> validation();
    ...
    static <CONFIG extends TrainingConfig> BestMetricData<CONFIG> of(ModelStats<CONFIG> train, ModelStats<CONFIG> validation, double outerTrain, double test) {
