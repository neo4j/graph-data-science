...
class HugeSparseObjectArrayListTest {

    @Test
    void shouldSetAndGet() {
        var random = ThreadLocalRandom.current();
        var array = HugeSparseObjectArrayList.of(42L, Long.class);
    ...
    @Test
    void shouldSetAndGetWithInitialCapacity() {
        var random = ThreadLocalRandom.current();
        var array = HugeSparseObjectArrayList.of(42L, 1337 * 1337, Long.class);
        long index = random.nextLong(0, 4096L + 1337L);
        long value = random.nextLong();
        array.set(index, value);
        assertThat(array.get(index)).isEqualTo(value);
