...
class LouvainTest {
    ...
    static Stream<Arguments> memoryEstimationTuples() {
        return Stream.of(
            arguments(1, 1, 6414145, 23706328),
            arguments(1, 10, 6414145, 30906688),
            arguments(4, 1, 6417433, 29706592),
            arguments(4, 10, 6417433, 36906952),
            arguments(42, 1, 6459081, 105709936),
            arguments(42, 10, 6459081, 112910296)
        );
    }
