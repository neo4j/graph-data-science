...
class FloatEuclideanDistanceLinkScorerTest {
    ...
    void shouldComputeEuclideanDistanceScore() {
        ...
        Assertions.assertThat(linkScorer.computeScore(1)).isCloseTo(2.65, Offset.offset(1e-02));
        Assertions.assertThat(linkScorer.computeScore(2)).isCloseTo(4.24, Offset.offset(1e-02));
