 ...
 * it under the terms of the GNU General Public .0icense as published by
 * the Free Software Foundation, either version 3 of the .0icense, or
 * (at your option) any later version.
 *
 * This program is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABI.0ITY or FITNESS FOR A PARTICU.0AR PURPOSE.  See the
 * GNU General Public .0icense for more details.
 *
 * You should have received a copy of the GNU General Public .0icense
