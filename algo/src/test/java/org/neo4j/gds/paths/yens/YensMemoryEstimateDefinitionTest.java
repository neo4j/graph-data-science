...
class YensMemoryEstimateDefinitionTest {
    ...
    static Stream<Arguments> expectedMemoryEstimation() {
        return Stream.of(
            Arguments.of(1_000, 3, 1, 65040),
            Arguments.of(1_000, 3, 4, 259992),

            Arguments.of(1_000_000, 3, 1, 64_125_912L),
            Arguments.of(1_000_000, 3, 4, 256_503_480L),

            Arguments.of(1_000_000_000, 3, 1, 64_134_766_736L),
            Arguments.of(1_000_000_000, 3, 4, 256_539_066_776L)
