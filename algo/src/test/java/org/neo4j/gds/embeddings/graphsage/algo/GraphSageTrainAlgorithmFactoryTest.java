    ...
    void testLogging() {
        ...
        AssertionsForInterfaceTypes.assertThat(messagesInOrder)
            ...
            .containsExactly(
                ...
                "GraphSageTrain :: Train model :: Epoch 1 of 2 :: Iteration 1 of 2 :: Average loss per node: 26.69",
                ...
                "GraphSageTrain :: Train model :: Epoch 2 of 2 :: Iteration 1 of 2 :: Average loss per node: 24.45",
                ...
                "GraphSageTrain :: Train model :: Epoch 2 of 2 :: Iteration 2 of 2 :: Average loss per node: 24.66",
