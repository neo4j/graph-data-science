...
class GraphSageModelTrainerTest {
    ...
    void trainsWithRelationshipWeight(AggregatorType aggregatorType) {
        ...
        var trainModel = new GraphSageModelTrainer(config, ExecutorServices.DEFAULT, ProgressTracker.NULL_TRACKER);
    ...
    void shouldTrainModelWithArrayProperties() {
        ...
        var trainer = new GraphSageModelTrainer(config, ExecutorServices.DEFAULT, ProgressTracker.NULL_TRACKER);
    ...
    void seededSingleBatch(long seed) {
        ...
        var trainer = new GraphSageModelTrainer(config, ExecutorServices.DEFAULT, ProgressTracker.NULL_TRACKER);
        var otherTrainer = new GraphSageModelTrainer(config, ExecutorServices.DEFAULT, ProgressTracker.NULL_TRACKER);
