...
class ScalePropertiesTest {
    ...
    void scaleSingleProperty() {
        var config = ScalePropertiesStreamConfigImpl.builder()
            ...
            .concurrency(1)
            .build();
        var algo = new ScaleProperties(graph, config, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT);
    ...
    void scaleArrayProperty() {
        ...
        var actual = new ScaleProperties(graph, arrayConfig, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
        ...
        var expected = new ScaleProperties(graph, singlePropConfig, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
    ...
    void supportLongAndFloatArrays(String scaler) {
        ...
        var expected = new ScaleProperties(graph, bConfig, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
        var actualLong = new ScaleProperties(graph, longArrayBConfig, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
        var actualDouble = new ScaleProperties(graph, doubleArrayBConfig, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
    ...
    void supportDoubleArrays() {
        ...
        var actual = new ScaleProperties(graph, config, ProgressTracker.NULL_TRACKER, ExecutorServices.DEFAULT)
            .compute()
            .scaledProperties();
