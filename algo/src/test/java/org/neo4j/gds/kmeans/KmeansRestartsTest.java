...
class KmeansRestartsTest {
    ...
    void shouldChangeWithRestarts() {
        ...
        var averageDistance1 = result1.averageDistanceToCentroid();
        ...
        assertThat(averageDistance1).isCloseTo(distances1.stream().sum() / 3.0, Offset.offset(1e-4));
        ...
        var averageDistance2 = result2.averageDistanceToCentroid();
        ...
        assertThat(averageDistance2).isCloseTo(distances2.stream().sum() / 3.0, Offset.offset(1e-4));
