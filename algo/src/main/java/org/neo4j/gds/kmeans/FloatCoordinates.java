...
public class FloatCoordinates  implements  Coordinates{
    ...
    FloatCoordinates(int k,int dimensions, NodePropertyValues nodePropertyValues){
    ...
    float coordinateAt(int coordinateId, int dimension){
        return  coordinates[coordinateId][dimension];
    }

    @Override
    public void add(int coordinateId, Coordinates outsideCoordinates) {
        if (outsideCoordinates instanceof  FloatCoordinates floatCoordinates) {
            for (int dimension = 0; dimension < dimensions; ++dimension) {
                coordinates[coordinateId][dimension] += floatCoordinates.coordinateAt(coordinateId,dimension);
            }
        }else {
