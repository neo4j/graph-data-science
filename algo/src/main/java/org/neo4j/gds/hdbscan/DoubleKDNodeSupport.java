...
class DoubleKDNodeSupport implements KDNodeSupport {
    ...
    DoubleKDNodeSupport(NodePropertyValues nodePropertyValues, HugeLongArray ids, int dimension) {
    ...
    public LongToDoubleFunction valueAt(int dimensionIndex) {
       return v -> nodePropertyValues.doubleArrayValue(ids.get(v))[dimensionIndex];
