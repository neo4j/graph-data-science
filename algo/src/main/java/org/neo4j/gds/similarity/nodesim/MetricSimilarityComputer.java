...
public interface MetricSimilarityComputer {
    ...
    static MetricSimilarityComputer create(NodeSimilarity.Metric metric, double similarityCutoff) {
        if (metric == NodeSimilarity.Metric.JACCARD) {
...
class JaccardSimilarityComputer implements MetricSimilarityComputer {
