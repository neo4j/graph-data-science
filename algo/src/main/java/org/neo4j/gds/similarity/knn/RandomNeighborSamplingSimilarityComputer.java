...
public class RandomNeighborSamplingSimilarityComputer {
    ...
    public RandomNeighborSamplingSimilarityComputer(
    ...
    private @Nullable HugeObjectArray<NeighborList> initializeRandomNeighbors() {
        ...
        var neighbors = HugeObjectArray.newArray(NeighborList.class, nodeCount, this.allocationTracker);
    ...
    private long iteration(HugeObjectArray<NeighborList> neighbors) {
        ...
        var allocationTracker = this.allocationTracker;
