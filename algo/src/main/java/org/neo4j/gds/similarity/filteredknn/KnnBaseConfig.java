...
public interface KnnBaseConfig extends AlgoBaseConfig, IterationsConfig, SingleThreadedRandomSeedConfig {
    ...
    @Value.Default
    @Configuration.ConvertWith("org.neo4j.gds.similarity.filteredknn.KnnSampler.SamplerType#parse")
    @Configuration.ToMapValue("org.neo4j.gds.similarity.filteredknn.KnnSampler.SamplerType#toString")
