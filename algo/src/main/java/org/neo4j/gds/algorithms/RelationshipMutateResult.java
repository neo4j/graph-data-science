...
@ValueClass
public interface RelationshipMutateResult<ALGORITHM_SPECIFIC_FIELDS>  {
    ...
    static <ASF> ImmutableRelationshipMutateResult.Builder<ASF> builder() {
        return ImmutableRelationshipMutateResult.builder();
    }

    static <ASF> RelationshipMutateResult<ASF> empty(ASF algorithmSpecificFields, AlgoBaseConfig config) {
