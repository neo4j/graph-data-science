...
public class ModularityOptimizationMutateProc {
    ...
    public Stream<ModularityOptimizationMutateResult> mutate(
        ...
        return facade.algorithms().community().modularityOptimizationMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().community().modularityOptimizationMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
