...
public class SpeakerListenerLPAWriteProc {
    ...
    public Stream<SpeakerListenerLPAWriteResult> write(
        ...
        return facade.algorithms().community().sllpaWrite(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().community().sllpaWriteEstimate(graphNameOrConfiguration, algoConfiguration);
    }
