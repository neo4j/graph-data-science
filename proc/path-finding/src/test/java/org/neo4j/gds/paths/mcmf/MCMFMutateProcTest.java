...
class MCMFMutateProcTest extends BaseProcTest {
    ...
    void setup() throws Exception {
        registerProcedures(MCMFMutateProc.class, GraphProjectProc.class);
    ...
    void testYields() {
        String query = GdsCypher.call(DEFAULT_GRAPH_NAME)
            ...
            .yields("totalFlow", "totalCost","relationshipsWritten");

        var rowCount = runQueryWithRowConsumer(query,
            resultRow -> {

                assertThat(resultRow.get("totalFlow")).isInstanceOf(Double.class);
                assertThat(resultRow.get("totalCost")).isInstanceOf(Double.class);
                ...
                assertThat((double) resultRow.get("totalCost")).isEqualTo(16D);
