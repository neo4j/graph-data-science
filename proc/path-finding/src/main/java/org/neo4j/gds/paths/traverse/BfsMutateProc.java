...
public class BfsMutateProc {
    ...
    @Procedure(name = "gds.bfs.mutate", mode = READ)
    @Description(BFS_DESCRIPTION)
    public Stream<PathFindingMutateResult> mutate(
        @Name(value = "graphName") String graphName,
        @Name(value = "configuration", defaultValue = "{}") Map<String, Object> configuration
    ) {
        return facade.algorithms().pathFinding().breadthFirstSearchMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().breadthFirstSearchMutateEstimate(
