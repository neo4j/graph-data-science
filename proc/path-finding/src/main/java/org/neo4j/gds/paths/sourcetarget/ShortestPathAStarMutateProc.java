...
public class ShortestPathAStarMutateProc {
    @Context
    ...
    public Stream<PathFindingMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathAStarMutateStub().execute(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathAStarMutateStub().estimate(
