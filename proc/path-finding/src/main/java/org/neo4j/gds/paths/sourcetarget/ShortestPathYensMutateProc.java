...
public class ShortestPathYensMutateProc {
    ...
    public Stream<PathFindingMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathYensMutateStub().execute(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathYensMutateStub().estimate(graphName, configuration);
    }
}
