...
public class ShortestPathYensMutateProc {
    ...
    public Stream<PathFindingMutateResult> mutate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathYensMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().pathFinding().singlePairShortestPathYensMutateEstimate(graphName, configuration);
    }
}
