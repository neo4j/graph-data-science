...
class NodeRegressionPipelineConfigureSplitProcTest extends NodeRegressionPipelineBaseProcTest {

    @BeforeEach
    void setUp() throws Exception {
        registerProcedures(NodeRegressionPipelineConfigureSplitProc.class);
    }
    ...
    void setSplitConfig() {
        ...
        var expectedSplitConfig = NodePropertyPredictionSplitConfigImpl
            .builder()
            .testFraction(0.42)
            .validationFolds(25)
            .build();

        assertCypherResult("CALL gds.alpha.pipeline.nodeRegression.configureSplit('myPipe', {testFraction: 0.42, validationFolds: 25})",
            List.of(Map.of(
                "name", "myPipe",
                "splitConfig", expectedSplitConfig.toMap(),
        ...
        assertThat(pipeline.splitConfig().toMap()).isEqualTo(expectedSplitConfig.toMap());
    }
