...
public class DoubleEuclideanDistanceLinkScorerTest {
    ...
    void shouldComputeEuclideanDistanceScore() {
        ...
        LinkScorer linkScorer = new DoubleEuclideanDistanceLinkScorer(ddnpv, DoubleArrayList.from(-1.0, 0.0, 0.0, 0.0));
        linkScorer.init(0);
