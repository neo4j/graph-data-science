...
class NodeRegressionPredictNewStreamConfigFn implements NewConfigFunction<NodeRegressionPredictPipelineBaseConfig> {
    ...
    NodeRegressionPredictNewStreamConfigFn(ModelCatalog modelCatalog) {
        this.modelCatalog = modelCatalog;
    }

    @Override
    public NodeRegressionPredictPipelineBaseConfig apply(String username, CypherMapWrapper config) {
        var basePredictConfig = NodeRegressionPredictPipelineBaseConfig.of(username, config);
