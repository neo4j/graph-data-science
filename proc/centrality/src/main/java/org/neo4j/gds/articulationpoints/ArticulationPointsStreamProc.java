...
public class ArticulationPointsStreamProc {
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().centrality().articulationPointsStreamEstimate(graphNameOrConfiguration, algoConfiguration);
    }
