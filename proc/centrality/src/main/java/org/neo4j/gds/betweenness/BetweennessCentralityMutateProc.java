...
public class BetweennessCentralityMutateProc {
    ...
    public Stream<CentralityMutateResult> mutate(
        ...
        return facade.algorithms().centrality().betweennessCentralityMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().centrality().betweennessCentralityMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
