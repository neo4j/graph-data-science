...
import static org.neo4j.gds.embeddings.node2vec.Constants.NODE2VEC_DESCRIPTION;
...
public class Node2VecStreamProc {
    ...
    public Stream<Node2VecStreamResult> stream(
        ...
        return facade.algorithms().nodeEmbeddings().node2VecStream(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().nodeEmbeddings().node2VecStreamEstimate(graphNameOrConfiguration, algoConfiguration);
    }
