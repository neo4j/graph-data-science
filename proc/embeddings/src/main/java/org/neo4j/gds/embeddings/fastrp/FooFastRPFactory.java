...
public class FooFastRPFactory<CONFIG extends FastRPBaseConfig> implements AlgorithmFactory<FastRP, CONFIG> {

    private final ProgressEventTracker progressTracker;

    FooFastRPFactory(ProgressEventTracker progressTracker) {
