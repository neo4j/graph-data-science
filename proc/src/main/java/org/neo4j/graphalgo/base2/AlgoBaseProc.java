...
public abstract class AlgoBaseProc<
    ...
    protected ComputationResult2<ALGO, ALGO_RESULT, CONFIG> compute(
    ...
    protected ComputationResult2<ALGO, ALGO_RESULT, CONFIG> compute(
        ...
        ImmutableComputationResult2.Builder<ALGO, ALGO_RESULT, CONFIG> builder = ImmutableComputationResult2.builder();
    ...
    @ValueClass
    public interface ComputationResult2<A extends Algorithm<A, RESULT>, RESULT, CONFIG extends AlgoBaseConfig> {
        long createMillis();
