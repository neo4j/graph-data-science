...
class GraphMutateProcIntegrationTest extends BaseProcTest {
    ...
    private static final Graph EXPECTED_GRAPH = fromGdl(
        "(a {nodeId: 0.0,  labelPropagation: 6,  louvain: 2,  pageRank: 0.150000, wcc: 0})" +
        "(b {nodeId: 1.0,  labelPropagation: 6,  louvain: 3,  pageRank: 0.277500, wcc: 0})" +
        "(c {nodeId: 2.0,  labelPropagation: 6,  louvain: 5,  pageRank: 0.385875, wcc: 0})" +
        ...
        "(i {nodeId: 8.0,  labelPropagation: 10, louvain: 11, pageRank: 0.277500, wcc: 7})" +
