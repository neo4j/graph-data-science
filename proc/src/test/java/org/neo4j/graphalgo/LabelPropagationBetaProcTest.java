...
public class LabelPropagationBetaProcTest {
    ...
    public LabelPropagationBetaProcTest(boolean parallel, String graphImpl) {
    ...
    public void shouldTakeDifferentSeedProperties() {
        String query = "CALL algo.beta.labelPropagation(null, null, {direction: 'OUTGOING', seedProperty: $seedProperty, weightProperty: $weightProperty, writeProperty: 'lpa'})";
        ...
        query = "CALL algo.beta.labelPropagation(null, null, {direction: 'OUTGOING', partitionProperty: $seedProperty, weightProperty: $weightProperty, writeProperty: 'lpa'})";
    ...
    public void shouldTakeParametersFromConfig() {
        String query = "CALL algo.beta.labelPropagation(null, null, {iterations: 5, write: false, weightProperty: 'score', seedProperty: $seedProperty})";
    ...
    public void shouldRunLabelPropagation() {
        String query = "CALL algo.beta.labelPropagation(null, 'X', {batchSize: $batchSize, direction: 'OUTGOING', concurrency: $concurrency, graph: $graph, seedProperty: $seedProperty, weightProperty: $weightProperty, writeProperty: $writeProperty})";
    ...
    public void shouldFilterByLabel() {
        String query = "CALL algo.beta.labelPropagation('A', 'X', {batchSize: $batchSize, direction: 'OUTGOING', concurrency: $concurrency, graph: $graph, writeProperty: $writeProperty})";
    ...
    public void shouldPropagateIncoming() {
        String query = "CALL algo.beta.labelPropagation('A', 'X', {batchSize: $batchSize, direction: 'INCOMING', concurrency: $concurrency, graph: $graph, seedProperty: $seedProperty, weightProperty: $weightProperty, writeProperty: $writeProperty})";
    ...
    public void shouldStreamResults() {
        ...
        runQuery("CALL algo.beta.labelPropagation(null, null, {iterations: 20, direction: 'OUTGOING', writeProperty: 'lpa', weightProperty: $weightProperty})", parParams(), row -> {});
