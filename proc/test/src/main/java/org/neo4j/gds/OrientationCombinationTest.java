...
public interface OrientationCombinationTest<ALGORITHM extends Algorithm<ALGORITHM, RESULT>, RESULT, PROC_RESULT, CONFIG extends AlgoBaseConfig> extends AlgoBaseProcTest<ALGORITHM, RESULT, PROC_RESULT, CONFIG> {
