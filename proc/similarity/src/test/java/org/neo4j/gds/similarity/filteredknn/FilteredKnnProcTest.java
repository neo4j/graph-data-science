...
abstract class FilteredKnnProcTest<CONFIG extends FilteredKnnBaseConfig> extends BaseProcTest implements
    AlgoBaseProcTest<FilteredKnn, CONFIG, FilteredKnnResult> {

    @TestFactory
    Stream<DynamicTest> configTests() {
        // Filtered KNN's createMinimalConfig() is not really minimal, but deterministic
    ...
    static final String GRAPH_NAME = "filteredKnnGraph";
    ...
    @Override
    public void assertResultEquals(FilteredKnnResult result1, FilteredKnnResult result2) {
        assertSimilarityStreamsAreEqual(result1.similarityResultStream(), result2.similarityResultStream());
    }
