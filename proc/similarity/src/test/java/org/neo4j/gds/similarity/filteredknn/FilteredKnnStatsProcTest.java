...
public final class FilteredKnnStatsProcTest extends FilteredKnnProcTest<FilteredKnnStatsConfig> {
    ...
    @Override
    public Class<? extends AlgoBaseProc<FilteredKnn, FilteredKnnResult, FilteredKnnStatsConfig, ?>> getProcedureClazz() {
        return FilteredKnnStatsProc.class;
    }

    @Override
    public FilteredKnnStatsConfig createConfig(CypherMapWrapper mapWrapper) {
        return FilteredKnnStatsConfig.of(mapWrapper);
    }
}
