...
public class FilteredKnnMutateProc {
    ...
    public Stream<KnnMutateResult> mutate(
        ...
        return facade.algorithms().similarity().filteredKnnMutateStub().execute(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().similarity().filteredKnnMutateStub().estimate(graphNameOrConfiguration, algoConfiguration);
    }
    ...
    public Stream<KnnMutateResult> alphaMutate(
        ...
        facade.deprecatedProcedures().called("gds.alpha.knn.filtered.mutate");
        facade.log().warn(
