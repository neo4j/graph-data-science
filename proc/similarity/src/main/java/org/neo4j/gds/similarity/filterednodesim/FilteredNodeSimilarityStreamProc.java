...
public class FilteredNodeSimilarityStreamProc {
    ...
    public Stream<SimilarityResult> stream(
        ...
        return facade.similarity().theOtherFacade().filteredNodeSimilarityStream(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.similarity().theOtherFacade().filteredNodeSimilarityStreamEstimate(graphNameOrConfiguration, algoConfiguration);
    }
