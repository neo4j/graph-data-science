...
public class KnnMutateProc {
    ...
    public Stream<KnnMutateResult> mutate(
        ...
        return facade.algorithms().similarity().knnMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().similarity().knnMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
