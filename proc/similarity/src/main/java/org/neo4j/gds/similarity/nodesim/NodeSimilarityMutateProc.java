...
public class NodeSimilarityMutateProc {
    ...
    public Stream<SimilarityMutateResult> mutate(
        ...
        return facade.algorithms().similarity().nodeSimilarityMutate(graphName, configuration);
    }
    ...
    public Stream<MemoryEstimateResult> estimate(
        ...
        return facade.algorithms().similarity().nodeSimilarityMutateEstimate(graphNameOrConfiguration, algoConfiguration);
    }
}
