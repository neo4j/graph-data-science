...
public class RestartCheckFunc {
    ...
    public void enableProc() {
        ...
        var function = globalProcedures.function(CheckRestartFunction.PROCEDURE_NAME);
        ...
        try {
            globalProcedures.register(new CheckRestartFunction(), false);
        } catch (ProcedureException e) {
            throw new RuntimeException("Could not register function: " + e.getMessage(), e);
        }
    }

    private static final class CheckRestartFunction implements CallableUserFunction {
