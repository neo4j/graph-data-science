...
class OpenGdsProcedureSmokeTest extends BaseProcTest {
    ...
    private static final List<String> PROCEDURES = asList(
       ...
       // "gds.alpha.topologicalSort.stream",
        ...
        "gds.pipeline.linkPrediction.addRandomForest",
        ...
        "gds.pipeline.nodeClassification.addRandomForest",
        ...
        "gds.beta.scaleProperties.stats.estimate",
        "gds.beta.scaleProperties.write",
        "gds.beta.scaleProperties.write.estimate",
