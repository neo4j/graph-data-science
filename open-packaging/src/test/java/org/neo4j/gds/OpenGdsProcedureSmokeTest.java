...
class OpenGdsProcedureSmokeTest extends BaseProcTest {
    ...
    private static final List<String> PROCEDURES = asList(
        ...
        "gds.nodeCount.stream",
        "gds.nodeCount.stream.estimate",
        ...
        "gds.triangles",
        "gds.splitRelationships.mutate",
        "gds.splitRelationships.mutate.estimate",
