...
class ReducedCrossEntropyLossTest implements FiniteDifferenceTest {
    ...
    void shouldApplyCorrectlyReduced() {
        ...
        var loss = new ReducedCrossEntropyLoss(predictions, weights, bias, features, labels, 0);
    ...
    void shouldApplyCorrectlyReducedWithFocus() {
        ...
        var loss = new ReducedCrossEntropyLoss(predictions, weights, bias, features, labels, 0.5);
        var ctx = new ComputationContext();
    ...
    void focalLossShouldDiscourageLowConfidencePrediction() {
        ...
        var focalLoss = new ReducedCrossEntropyLoss(predictions, weights, bias, features, labels, 5);
        ...
        var focalLossForBadPredictions = new ReducedCrossEntropyLoss(badPredictions, weights, bias, features, labels, 5);
