 ...
 */
@ValueClass
public interface BestMetricStandardData extends BestMetricData {
    ...
    static BestMetricStandardData of(BestModelStats train, BestModelStats validation, double outerTrain, double test) {
        return ImmutableBestMetricStandardData.of(train, validation, outerTrain, test);
    }
