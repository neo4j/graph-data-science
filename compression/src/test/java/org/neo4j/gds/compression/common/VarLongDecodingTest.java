...
class VarLongDecodingTest {

    @Test
    void decodeDeltaVLongsLength() {
        ...
        int result = VarLongDecoding.decodeDeltaVLongsLengthSwar(page, into, targets1EncodedSize);
        assertThat(result).isEqualTo(targets1.length);

        result = VarLongDecoding.decodeDeltaVLongsLengthSwar(page, into + targets1EncodedSize, targets2EncodedSize);
        assertThat(result).isEqualTo(targets2.length);
    }

    @Test
    void decodedVLongByteSizeFullWord() {
        ...
        int result = VarLongDecoding.decodeDeltaVLongsLengthSwar(page, into, targetsEncodedSize);

        assertThat(result).isEqualTo(targets.length);
    }

    @Test
    void decodedVLongByteSizeOverflowOneWord() {
    ...
    @Test
    void decodedVLongByteSizeTargetValueLargerThanOneWord() {
