...
public final class PackedAdjacencyListBuilder implements AdjacencyListBuilder<Address, PackedAdjacencyList> {
    ...
    public PackedAdjacencyListBuilder(MemoryTracker memoryTracker) {
    ...
    @Override
    public AdjacencyListBuilder.PositionalAllocator<Address> newPositionalAllocator() {
        throw new UnsupportedOperationException("Packed adjacency lists do not support positional allocation.");
    }

    @Override
    public PackedAdjacencyList build(HugeIntArray degrees, HugeLongArray offsets, HugeIntArray lengths, boolean allowReordering) {
