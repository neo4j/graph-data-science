...
import static org.neo4j.gds.compression.packed.AdjacencyPackerUtil.BYTE_ARRAY_BASE_OFFSET;
import static org.neo4j.gds.compression.packed.AdjacencyPackerUtil.bitsNeeded;
import static org.neo4j.gds.compression.packed.AdjacencyPackerUtil.bytesNeeded;

/**
 * Compresses values in blocks of {@link org.neo4j.gds.compression.packed.AdjacencyPacking#BLOCK_SIZE} using bit-packing.
 * <p>
 * If a block to compress has less than {@link org.neo4j.gds.compression.packed.AdjacencyPacking#BLOCK_SIZE} values,
 * this strategy uses a loop-based packing approach to compress the values in that block.
 */
public final class PackedTailPacker {
