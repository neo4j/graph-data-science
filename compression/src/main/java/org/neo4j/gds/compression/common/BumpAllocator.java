 ...
 * The name follows the description of the <a href="https://shipilev.net/jvm/anatomy-quarks/4-tlab-allocation">TLAB-allocation from the JVM</a>.
 */
public final class BumpAllocator<PAGE> {
    ...
    public static final class LocalPositionalAllocator<PAGE> {
         ...
         */
        public void insertAt(long offset, PAGE page, int length) {
        ...
        private void insertData(long offset, PAGE page, int length, long capacity, int targetsLength) {
        ...
        private PAGE allocateNewPages(long offset, PAGE page, int length, int targetsLength) {
            int pageId = PageUtil.pageIndex(offset, PAGE_SHIFT);
