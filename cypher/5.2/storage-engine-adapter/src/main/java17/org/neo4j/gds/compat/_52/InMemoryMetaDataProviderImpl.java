...
public class InMemoryMetaDataProviderImpl implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository52 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProviderImpl() {
        this.logVersionRepository = new InMemoryLogVersionRepository52();
    ...
    AbstractTransactionIdStore transactionIdStore() {
