...
import org.neo4j.internal.recordstorage.InMemoryLogVersionRepository52;
import org.neo4j.internal.recordstorage.InMemoryStorageCommandReaderFactory52;
...
public class InMemoryStorageEngineFactory implements StorageEngineFactory {
    ...
    public CommandReaderFactory commandReaderFactory() {
        return InMemoryStorageCommandReaderFactory52.INSTANCE;
    }
    ...
    public LogVersionRepository readOnlyLogVersionRepository(LogTailMetadata logTailMetadata) {
        return new InMemoryLogVersionRepository52();
    }
