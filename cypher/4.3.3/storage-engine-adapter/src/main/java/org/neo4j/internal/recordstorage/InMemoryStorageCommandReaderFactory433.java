...
public class InMemoryStorageCommandReaderFactory433 implements CommandReaderFactory {

    public static final CommandReaderFactory INSTANCE = new InMemoryStorageCommandReaderFactory433();
