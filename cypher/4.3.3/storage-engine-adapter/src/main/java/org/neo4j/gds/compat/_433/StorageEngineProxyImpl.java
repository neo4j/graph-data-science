...
public class StorageEngineProxyImpl implements StorageEngineProxyApi {
    ...
    public StorageReader inMemoryStorageReader(
        ...
        return new InMemoryStorageReader433(graphStore, tokenHolders, counts);
    }
    ...
    public void createInMemoryDatabase(
        ...
        config.set(storage_engine, InMemoryStorageEngineFactory433.IN_MEMORY_STORAGE_ENGINE_NAME_43);
