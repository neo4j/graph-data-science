...
public class InMemoryMetaDataProvider implements MetadataProvider {
    ...
    private final InMemoryLogVersionRepository43 logVersionRepository;
    private final InMemoryTransactionIdStoreImpl transactionIdStore;

    InMemoryMetaDataProvider() {
        this.logVersionRepository = new InMemoryLogVersionRepository43();
    ...
    public InMemoryLogVersionRepository43 logVersionRepository() {
