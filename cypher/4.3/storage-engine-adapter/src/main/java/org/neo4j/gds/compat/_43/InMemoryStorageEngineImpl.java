...
public final class InMemoryStorageEngineImpl implements StorageEngine {
    ...
    private final InMemoryCountsStore countsStore;
    private final InMemoryCommandCreationContextImpl commandCreationContext;
    ...
    InMemoryStorageEngineImpl(
        ...
        this.metadataProvider = new InMemoryMetaDataProvider();
    }
    ...
    private static CypherGraphStore getGraphStoreFromCatalog(String databaseName) {
        ...
        return (CypherGraphStore) GraphStoreCatalog
            .getAllGraphStores()
    ...
    public StorageReader newReader() {
        return new InMemoryStorageReader43(graphStore, tokenManager.tokenHolders(), countsStore);
    }
