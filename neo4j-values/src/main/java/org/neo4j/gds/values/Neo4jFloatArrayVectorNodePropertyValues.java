...
public class Neo4jFloatArrayVectorNodePropertyValues implements FloatArrayNodePropertyValues, Neo4jNodePropertyValues {

    private final NodePropertyValues internal;

    public Neo4jFloatArrayVectorNodePropertyValues(NodePropertyValues internal) {
