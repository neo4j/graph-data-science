...
public class Neo4jDoubleArrayVectorNodePropertyValues implements DoubleArrayNodePropertyValues, Neo4jNodePropertyValues {

    private final NodePropertyValues internal;

    public Neo4jDoubleArrayVectorNodePropertyValues(NodePropertyValues internal) {
